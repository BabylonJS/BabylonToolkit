declare namespace UNITY {
    ...
    class SceneManager {
        ...
        static OnSceneLoadedObservable: BABYLON.Observable<string>;
...
declare namespace UNITY {
    ...
    class MetadataParser {
        ...
        finalProcessSceneComponents(preloadList: Array<UNITY.ScriptComponent>, readyList: Array<UNITY.ScriptComponent>): void;
...
declare class CVTOOLS_unity_metadata implements BABYLON.GLTF2.IGLTFLoaderExtension {
    ...
    startParsing(): void;
    /** @hidden */
    parseScriptBundle(): Promise<void>;
    /** @hidden */
