...
declare namespace UNITY {
    ...
    class SceneManager {
        ...
        static InitializePlayground(engine: BABYLON.Engine, showLoadingScreen?: boolean, defaultLoadingUIText?: string, hideLoadingUIWithEngine?: boolean): void;
        /** Hide default loading screen panel */
        static HideLoadingScreen(loadingScreen: BABYLON.ILoadingScreen): void;
