...
(function (PROJECT) {
    ...
    class MyRotator extends TOOLKIT.ScriptComponent {
        ...
        constructor(transform, scene, properties) {
            super(transform, scene, properties, "PROJECT.MyRotator");
        }
        awake() {
            /* Init component function */
        }
        ...
        update() {
            this.transform.addRotation(0, this.speed * this.getDeltaTime(), 0);
        }
        late() {
            /* Late update render loop function */
        }
...
(function (PROJECT) {
    ...
    */
    class CustomHtmlMarkup extends TOOLKIT.ScriptComponent {
        styleSheet = null;
        htmlMarkup = null;
        parentElement = "";
        uiParentElement = null;
        awake() {
...
(function (PROJECT) {
    ...
    */
    class UserInterface extends TOOLKIT.ScriptComponent {
            ...
            if (element != null) {
                if (fadeSpeedRatio > 0) {
                    ...
                    if (onAnimationComplete != null)
                        onAnimationComplete();
                    //result = TOOLKIT.SceneManager.StartTweenAnimation(PROJECT.UserInterface.SceneController, (element.name + "-ShowAlphaTween"), element, "alpha", alphaStart, alphaEnd, fadeSpeedRatio, null, null, null, ()=>{
                    //    element.isEnabled = true;
        ...
        static HideCanvasElement(element, fadeSpeedRatio = 0.0, onAnimationComplete = null) {
            ...
            if (element != null) {
                if (fadeSpeedRatio > 0) {
                    ...
                    if (onAnimationComplete != null)
                        onAnimationComplete();
                    //result = TOOLKIT.SceneManager.StartTweenAnimation(PROJECT.UserInterface.SceneController, (element.name + "-HideAlphaTween"), element, "alpha", alphaStart, alphaEnd, fadeSpeedRatio, null, null, null, ()=>{
                    //    if (onAnimationComplete != null) onAnimationComplete();
                    //});
                }
                else {
        ...
        static OnFontFacesReady = new BABYLON.Observable();
        static OnFontFacesLoaded = new BABYLON.Observable();
        static OnParseNodeObject = new BABYLON.Observable();
        static OnInterfaceLoaded = new BABYLON.Observable();
        static SceneController = null;
        static AdvancedTexture = null;
        static BackgroundTexture = null;
        static FontFacesAttached = false;
        static FontFacesPreloaded = false;
        exportLowerCase = false;
        backgroundData = null;
        textureSampleMode = 2;
        idealRenderingSize = 0;
        viewportRenderSize = 0;
        customViewportSize = new BABYLON.Vector2(1920, 1080);
        defaultImageLocation = "scenes/assets/";
        defaultImageControl = true;
        isManagedTexture = true;
        scaleTextureSize = true;
        setAdaptiveScale = true;
        drawAtIdealSize = true;
        useSmallestIdeal = false;
        fontFamilyList = null;
        constructor(transform, scene, properties) {
                ...
                if (interfaceJson != null && interfaceJson !== "") {
                    ...
                    if (interfaceParsed != null) {
                        ...
                        if (this.isManagedTexture === true) {
                            if (TOOLKIT.SceneManager.AdvDynamicTexture == null)
                                TOOLKIT.SceneManager.AdvDynamicTexture = BABYLON.GUI.AdvancedDynamicTexture.CreateFullscreenUI("Default-Screen-UI", true, this.scene, this.textureSampleMode, this.setAdaptiveScale);
                            PROJECT.UserInterface.AdvancedTexture = TOOLKIT.SceneManager.AdvDynamicTexture;
                        }
                        else {
...
(function (PROJECT) {
    ...
    */
    class NodeMaterialInstance extends TOOLKIT.ScriptComponent {
        nodeMaterialData = null;
        setCustomRootUrl = null;
...
(function (PROJECT) {
    ...
    */
    class NodeMaterialParticle extends TOOLKIT.ScriptComponent {
        nodeMaterialEditor = null;
        awake() {
            /* Init component function */
        }
        start() {
            if (this.nodeMaterialEditor != null) {
                const nme = TOOLKIT.SceneManager.FindScriptComponent(this.nodeMaterialEditor, "PROJECT.NodeMaterialInstance");
                if (nme != null) {
...
(function (PROJECT) {
    ...
    */
    class MobileInputController extends TOOLKIT.ScriptComponent {
        ...
        maxMoveDeadzone = 4;
        uiParentElement = null;
        leftBaseElement = null;
        rightBaseElement = null;
        buttonBaseElement = null;
        leftStickStyle = 0;
        rightStickStyle = 0;
        leftStickFactor = 1.0;
        rightStickFactor = 1.0;
        invertLeftStickY = true;
        centerLeftJoystick = false;
        enableLeftJoystick = true;
        invertRightStickY = true;
        centerRightJoystick = false;
        enableRightJoystick = true;
        enableMouseAxes = false;
        enableVirtualButtons = false;
        virtualButtonControls = null;
        m_leftStick = null;
        m_rightStick = null;
        ...
        awake() {
            this.m_mobileDevice = TOOLKIT.WindowManager.IsMobile();
        ...
        ready() {
            if (this.controlType === 1 || this.m_mobileDevice === true) {
                TOOLKIT.SceneManager.VirtualJoystickEnabled = !this.enableMouseAxes; // Note: Disable MouseX And MouseY User Input Axes
                const displayTimeout = (this.maxReadyTimeout >= 10) ? this.maxReadyTimeout : 10;
                TOOLKIT.WindowManager.SetTimeout(displayTimeout, () => {
                    this.createHtmlElements();
                    if (this.enableLeftJoystick === true)
                        this.m_leftStick = new TOOLKIT.TouchJoystickHandler("stick1", this.maxMoveDistance, this.maxMoveDeadzone);
                    if (this.enableRightJoystick === true)
                        this.m_rightStick = new TOOLKIT.TouchJoystickHandler("stick2", this.maxMoveDistance, this.maxMoveDeadzone);
                });
            }
        }
        update() {
            if (this.controlType === 1 || this.m_mobileDevice === true) {
                if (TOOLKIT.InputController.AllowMobileControls === true) {
                    // ..
                    // TODO: Validate Mobile Control Visuals Are Enabled
                    // ..
                    if (this.enableLeftJoystick === true && this.m_leftStick != null) {
                        TOOLKIT.InputController.MobileControlsActive = true;
                        ...
                        TOOLKIT.InputController.SetLeftJoystickBuffer(leftStickFixedX, leftStickFixedY, this.invertLeftStickY);
                    }
                    if (this.enableRightJoystick === true && this.m_rightStick != null) {
                        ...
                        TOOLKIT.InputController.SetRightJoystickBuffer(rightStickFixedX, rightStickFixedY, this.invertRightStickY);
                    }
                    if (this.enableVirtualButtons === true) {
                        TOOLKIT.InputController.MobileControlsActive = true;
                    }
                    // const rightMouseButtonDown: boolean = TOOLKIT.InputController.GetRightButtonDown();
                    // if (rightMouseButtonDown === true)
                    // {
                    //     const screenX: number = this.scene.pointerX;
                    //     const screenY: number = this.scene.pointerY;
                    //     if (this.leftBaseElement != null) {
                    //         this.leftBaseElement.style.top = (screenY - 50) + "px";
                    //         this.leftBaseElement.style.left = (screenX - 50) + "px";
                    //     } 
                    //     TOOLKIT.WindowManager.PrintToScreen("ScreenX: " + screenX + " ScreenY: " + screenY);
                    // }
                }
                else {
                    // ..
        ...
        protected checkOrientation(): void {
            const orientation: string = TOOLKIT.WindowManager.GetOrientation();
        ...
        */
        ...
        createHtmlElements() {
            const rootUrl = TOOLKIT.SceneManager.GetRootUrl(this.scene);
            ...
            if (this.enableLeftJoystick === true) {
                ...
                ballImg1.oncontextmenu = () => { return false; };
                // ..
            ...
            if (this.enableRightJoystick === true) {
                ...
                ballImg2.oncontextmenu = () => { return false; };
                // ..
            ...
            if (this.enableVirtualButtons === true) {
                ...
                this.buttonBaseElement.oncontextmenu = () => { return false; };
                if (this.virtualButtonControls != null) {
                    this.virtualButtonControls.forEach((element, index) => {
                        ...
                        virtualButton.oncontextmenu = () => { return false; };
                        virtualButton.addEventListener("pointerdown", (e) => { TOOLKIT.InputController.InputKeyDownHandler(element.inputKeyCode, e); });
                        virtualButton.addEventListener("pointerup", (e) => { TOOLKIT.InputController.InputKeyUpHandler(element.inputKeyCode, e); });
                        if (buttonImageData != null && buttonImageData.filename != null) {
                            if (element.buttonCover === 0) {
                                ...
                                buttonImg.oncontextmenu = () => { return false; };
    ...
    class FreeCameraTouchJoystickInput {
         ...
         */
        joystickAngularSensibility = 200;
        /**
         * Defines the joystick move sensiblity.
         * This is the threshold from when moving starts to be accounted for for to prevent jittering.
         */
        joystickMoveSensibility = 40.0;
        /**
        ...
        // private members
        LSValues = new BABYLON.Vector2(0, 0);
        RSValues = new BABYLON.Vector2(0, 0);
        _cameraTransform = BABYLON.Matrix.Identity();
        _deltaTransform = BABYLON.Vector3.Zero();
        _vector3 = BABYLON.Vector3.Zero();
        _vector2 = BABYLON.Vector2.Zero();
        _attached = false;
        /**
...
(function (PROJECT) {
    ...
    */
    class ColyseusGameServer extends TOOLKIT.ScriptComponent {
        static MAX_FRAME_RATE = 200;
        projectName = "Game Project";
        autoJoinRoom = true;
        playerUserName = "Player";
        defaultRoomName = "default";
        roomLogicModule = "DefaultLogic";
        maxClientsAllowed = 8;
        patchUpdateRateFps = 20;
        roomSimulateRateFps = 60;
        networkBufferingTime = 0.15;
        soloSession = false;
        colyseusAvailable = false;
        networkRoomConnected = false;
        hostSessionName = null;
        joinRoomId = null;
        client = null;
        static StaticInstance = null;
        ...
        awake() {
            ...
            try {
                const playerSoloParam = TOOLKIT.WindowManager.GetUrlParameter("solo");
            ...
            if (this.colyseusAvailable === true) {
                try {
                    const serverEndpointParam = TOOLKIT.WindowManager.GetUrlParameter("endpoint");
                    if (serverEndpointParam != null && serverEndpointParam !== "") {
                        ...
                        if (serverEndpoint != null && serverEndpoint !== "" && serverEndpoint !== "*") {
                            TOOLKIT.SceneManager.ServerEndPoint = serverEndpoint;
                        }
                    }
                }
                catch (e0) {
                ...
                try {
                    const playerNameParam = TOOLKIT.WindowManager.GetUrlParameter("player");
                ...
                try {
                    const roomNameParam = TOOLKIT.WindowManager.GetUrlParameter("room");
                ...
                try {
                    const hostSessionParam = TOOLKIT.WindowManager.GetUrlParameter("host");
                ...
                try {
                    const joinSessionParam = TOOLKIT.WindowManager.GetUrlParameter("join");
        ...
        async joinRoom() {
            ...
            if (this.colyseusAvailable === true) {
                try {
                    const websocketUrl = (TOOLKIT.SceneManager.ServerEndPoint.toLowerCase().startsWith("http")) ? ("ws" + TOOLKIT.SceneManager.ServerEndPoint.substring(4)) : TOOLKIT.SceneManager.ServerEndPoint;
                    if (TOOLKIT.SceneManager.ServerEndPoint.endsWith("/"))
                        TOOLKIT.SceneManager.ServerEndPoint = TOOLKIT.SceneManager.ServerEndPoint.substring(0, (TOOLKIT.SceneManager.ServerEndPoint.length - 1));
                    if (this.projectName == null || this.projectName === "")
                        this.projectName = "Game Project";
                    console.log(">>> Server Endpoint: " + TOOLKIT.SceneManager.ServerEndPoint);
                    ...
                    if (this.hostSessionName != null && this.hostSessionName !== "") {
                        const sceneFile = TOOLKIT.SceneManager.GetSceneFile(this.scene);
                        room = await this.client.create(this.defaultRoomName, {
                        ...
                        room = await this.client.joinById(this.joinRoomId, {
                            userName: this.playerUserName
                        });
                    }
                    if (room != null) {
...
(function (PROJECT) {
    ...
    */
    class ColyseusNetworkAvatar extends TOOLKIT.ScriptComponent {
        static FONT_PADDING = 36;
        static HEIGHT_PADDING = 0.1;
        controlMode = 0;
        defaultAvatar = null;
        maleAnimationRig = null;
        femaleAnimationRig = null;
        castRealtimeShadow = true;
        disposeOfMannequin = true;
        pixelOffsetX = 0;
        pixelOffsetY = 0;
        playerJoined = false;
        preloadLocation = null;
        ambientMaterial = new BABYLON.Color3(1.0, 1.0, 1.0);
        avatarArmature = null;
        avatarSkeleton = null;
        avatarHandness = "Left";
        avatarGender = "Male";
        avatarLabel = "Default Player";
        avatarLoaded = false;
        //private animator: TOOLKIT.AnimationState = null;
        avatarReady = false;
        manageLabelTexture = true;
        ...
        labelOffsetY = 2.0;
        labelHeight = 64;
        labelColor = new BABYLON.Color3(0.0, 1.0, 0.0);
        labelAlpha = 0.85;
        rectColor = new BABYLON.Color3(0.0, 0.0, 0.0);
        rectAlpha = 0.65;
        fontFamily = "Arial";
        fontStyle = "Bold";
        fontSize = 36;
        fillRect = true;
        awake() {
            //this.animator = this.getComponent("TOOLKIT.AnimationState");
            //if (this.animator == null) BABYLON.Tools.Warn("Failed to locate aniation state component for: " + this.transform.name);
        ...
        createAvatarLabel(name) {
            if (name != null && name !== "") {
                ...
                plane.renderingGroupId = TOOLKIT.Utilities.DefaultRenderGroup();
            }
        }
        ...
        setupLocalPlayerAvatar() {
            try {
                const playerAvatarParam = TOOLKIT.WindowManager.GetUrlParameter("avatar");
            ...
            try {
                const playerGenderParam = TOOLKIT.WindowManager.GetUrlParameter("gender");
            ...
            try {
                const playerHandnessParam = TOOLKIT.WindowManager.GetUrlParameter("hand");
            ...
            let colyseus = TOOLKIT.SceneManager.FindScriptComponent(this.transform, klass);
            if (colyseus == null) {
                if (this.transform.parent != null) {
                    colyseus = TOOLKIT.SceneManager.FindScriptComponent(this.transform.parent, klass);
                    if (colyseus == null) {
                        if (this.transform.parent.parent != null) {
                            colyseus = TOOLKIT.SceneManager.FindScriptComponent(this.transform.parent.parent, klass);
                            if (colyseus == null) {
                                if (this.transform.parent.parent.parent != null) {
                                    colyseus = TOOLKIT.SceneManager.FindScriptComponent(this.transform.parent.parent.parent, klass);
                                }
                            }
                        }
                    }
            ...
            if (this.defaultAvatar != null && this.defaultAvatar !== "") {
                if (TOOLKIT.SceneManager.HasSceneBeenPreLoaded(this.scene)) {
        ...
        setupRemotePlayerAvatar() {
            ...
            if (remoteEntity != null && remoteEntity.transformNode != null && remoteEntity.transformNodeType != null && remoteEntity.transformNodeType === 2) {
                const playerAvatar = TOOLKIT.EntityController.QueryNetworkAttribute(remoteEntity.transformNode, "playerAvatar");
                if (playerAvatar != null && playerAvatar !== "") {
                    this.defaultAvatar = playerAvatar;
                }
                const playerGender = TOOLKIT.EntityController.QueryNetworkAttribute(remoteEntity.transformNode, "playerGender");
                if (playerGender != null && playerGender !== "") {
                    this.avatarGender = playerGender;
                }
                const playerHand = TOOLKIT.EntityController.QueryNetworkAttribute(remoteEntity.transformNode, "playerHand");
                if (playerHand != null && playerHand !== "") {
                    this.avatarHandness = playerHand;
                }
                const ownerName = TOOLKIT.EntityController.QueryNetworkAttribute(remoteEntity.transformNode, "ownerName");
        ...
        configurePlayerAvatarRig(root) {
            if (root != null) {
                ...
                if (meshes != null && meshes.length > 0) {
                    meshes.forEach((mesh) => {
                        mesh.renderingGroupId = TOOLKIT.Utilities.DefaultRenderGroup();
                    });
                }
                ...
                if (this.avatarSkeleton != null) {
                    const animationRig: string = (this.avatarGender != null && this.avatarGender.toLowerCase() === "female") ? this.femaleAnimationRig : this.maleAnimationRig;
                    if (animationRig != null && animationRig !== "") {
                        const animationAsset: BABYLON.AssetContainer = TOOLKIT.SceneManager.GetAssetContainer(this.scene, animationRig);
                        if (animationAsset != null && animationAsset.animationGroups != null) {
                            let cgroups: BABYLON.AnimationGroup[] = null;
                            let xclips: any[] = (this.animator != null) ? this.animator.getDefaultClips() : null;
                            animationAsset.animationGroups.forEach((agroup, index) => {
                                try { agroup.stop(); } catch { }
                                const newname = (this.transform.name + "." + agroup.name);
                                const cgroup = agroup.clone(newname, null, false);
                                if (cgroup != null) {
                                    cgroup.loopAnimation = true;
                                    TOOLKIT.Utilities.RetargetAnimationGroupSkeleton(cgroup, this.avatarSkeleton, this.avatarArmature);
                                    if (this.animator != null && xclips != null) {
                                        const xclip = this.animator.fixAnimationGroup(cgroup);
                                        if (xclip != null) {
                                            if (cgroups == null) cgroups = [];
                                            cgroups.push(cgroup);
                                        } else {
...
(function (PROJECT) {
    ...
    class ColyseusNetworkEntity extends TOOLKIT.ScriptComponent {
        ...
        remotePrefab = null;
        assetContainer = null;
        movementEpsilon = 0.00001;
        movementMethod = BABYLON.EntityMovementType.ClientAuthority;
        interpolationMode = BABYLON.EntityInterpolation.Default;
        interpolationHandler = null;
        syncTransformNode = true;
        runtimeAttributes = null;
        creationAttributes = null;
        bufferedAttributes = null;
        networkEntityCreated = false;
        update() {
        ...
        destroy() {
            ...
            const entityId = TOOLKIT.EntityController.GetNetworkEntityId(this.transform);
...
(function (BABYLON) {
    ...
    class NetworkManager {
        ...
        static NetworkServerTime = 0;
        static NetworkEntityQueue = null;
        static CustomHandlerMap = new Map();
        static SendPositionBuffer = new BABYLON.Vector3(0, 0, 0);
        static SendRotationBuffer = new BABYLON.Quaternion(0, 0, 0, 1);
        static SendLinearBuffer = new BABYLON.Vector3(0, 0, 0);
        static SendAngularBuffer = new BABYLON.Vector3(0, 0, 0);
        static SceneReference = null;
        static InterpolationBuffer = 0.15;
        static OnConnectObservable = new BABYLON.Observable();
        ...
        static OnSceneBeforeRenderUpdate() {
            const deltaTime = TOOLKIT.SceneManager.GetDeltaSeconds(BABYLON.NetworkManager.SceneReference);
                        ...
                        if (mx != null && (mx.dispatched == null || mx.dispatched == false)) {
                            try {
                                if (BABYLON.NetworkManager.OnChatMessageObservable && BABYLON.NetworkManager.OnChatMessageObservable.hasObservers()) {
                                    BABYLON.NetworkManager.OnChatMessageObservable.notifyObservers({ ...mx });
                                }
                            }
                            catch (e) {
                                console.error(e);
        ...
        static CreateNetworkPacketData(localTransform, postAttributes = true) {
            ...
            if (networkEntity != null) {
                if (localTransform.networkEntityMovement != null && localTransform.networkEntityMovement === BABYLON.EntityMovementType.ClientAuthority) {
                    TOOLKIT.Utilities.GetAbsolutePositionToRef(localTransform, BABYLON.NetworkManager.SendPositionBuffer);
                    TOOLKIT.Utilities.GetAbsoluteRotationToRef(localTransform, BABYLON.NetworkManager.SendRotationBuffer);
                    // ..
            ...
            if (isLocalEntity === false) {
                ...
                if (remotePrefab != null && remotePrefab !== "") {
                    if (assetContainer != null && assetContainer !== "") {
                        const contaier = TOOLKIT.SceneManager.GetAssetContainer(sceneRef, assetContainer);
                        if (contaier != null) {
                            transformNode = TOOLKIT.SceneManager.InstantiatePrefabFromContainer(contaier, remotePrefab, transformNodeName, BABYLON.NetworkManager.RootNode, initialPosition, initialRotation);
                        ...
                        transformNode = TOOLKIT.SceneManager.InstantiatePrefabFromScene(sceneRef, remotePrefab, transformNodeName, BABYLON.NetworkManager.RootNode, initialPosition, initialRotation);
                        if (transformNode == null)
                ...
                if (transformNode != null) {
                    if (playerAvatar != null && playerAvatar !== "") {
                        ...
                        if (skins != null && skins.length > 0) {
                            skins.forEach((skin) => {
                                const stag = TOOLKIT.SceneManager.GetTransformTag(skin);
                ...
                transformNode = TOOLKIT.SceneManager.GetTransformNodeByID(sceneRef, entity.creationId);
                if (transformNode == null)
    ...
    class InterpolationBuffer {
        ...
        hermiteToolkit(target, t, p1, p2, v1, v2) {
            //const deltaTime:number = TOOLKIT.SceneManager.GetDeltaSeconds(BABYLON.NetworkManager.SceneReference);
            TOOLKIT.Utilities.HermiteVector3ToRef(p1, v1, p2, v2, t, target);
        }
...
(function (PROJECT) {
    ...
    */
    class FixedHingeJoint extends TOOLKIT.ScriptComponent {
        bodyA = null;
        bodyB = null;
        pivotA = new BABYLON.Vector3(0, 0, -0.5);
        pivotB = new BABYLON.Vector3(0, 0, 0.5);
        constraint = null;
        collisionsEnabled = false;
        awake() {
            const bodyAInfo = this.getProperty("bodyA");
...
(function (PROJECT) {
    ...
    */
    class LockedJoint extends TOOLKIT.ScriptComponent {
        bodyA = null;
        bodyB = null;
        pivotA = new BABYLON.Vector3(0.5, 0.5, -0.5);
        pivotB = new BABYLON.Vector3(-0.5, -0.5, 0.5);
        axisA = new BABYLON.Vector3(0, 1, 0);
        axisB = new BABYLON.Vector3(0, 1, 0);
        constraint = null;
        collisionsEnabled = false;
...
(function (PROJECT) {
    ...
    */
    class PrismaticJoint extends TOOLKIT.ScriptComponent {
        bodyA = null;
        bodyB = null;
        pivotA = new BABYLON.Vector3(0, 0, -0.2);
        pivotB = new BABYLON.Vector3(0, 0, 0.25);
        axisA = new BABYLON.Vector3(0, 1, 0);
        axisB = new BABYLON.Vector3(0, 1, 0);
        constraint = null;
        collisionsEnabled = false;
    ...
    */
    class RemotePlayerController extends TOOLKIT.ScriptComponent {
        ...
        update() {
            ...
            // ..
            if (TOOLKIT.EntityController.HasNetworkEntity(this.transform)) {
                const direction = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 0); // Direction
                const magnitude = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 1); // Magnitude
                const inputX = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 2); // Horizonal
                const inputZ = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 3); // Vertical
                const mouseX = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 4); // MouseX
                const mouseY = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 5); // Mousey
                const vvelocity = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 6); // Vertical Velocity
                const movespeed = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 7); // Movement Speed
                const actionstate = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 8); // Action State
                const jumpframe = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 9); // Jump Frame
                const isjumping = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 10); // Is Jumping
                const isfalling = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 11); // Is Falling
                const issliding = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 12); // Is Sliding
                const isgrounded = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 13); // Is Grounded
                // ..
        ...
        attachAnimationController() {
            if (this.animationState == null) {
                this.animationState = this.getComponent("TOOLKIT.AnimationState");
                if (this.animationState == null) {
                    const animationNode = this.getChildWithScript("TOOLKIT.AnimationState");
                    if (animationNode != null) {
                        this.animationState = TOOLKIT.SceneManager.FindScriptComponent(animationNode, "TOOLKIT.AnimationState");
                    }
                    else {
                        // DEBUG: TOOLKIT.SceneManager.LogWarning("Failed to locate animator node for: " + this.transform);
                    }
                }
            }
            if (this.animationState != null) {
...
(function (PROJECT) {
    ...
    */
    class StandardPlayerController extends TOOLKIT.ScriptComponent {
        static MIN_VERTICAL_VELOCITY = 0.01;
        static MIN_GROUND_DISTANCE = 0.15;
        static MIN_MOVE_EPSILON = 0.001;
        static MIN_TIMER_OFFSET = 0;
        static MIN_SLOPE_LIMIT = 0;
        static PLAYER_HEIGHT = "playerHeight";
        enableInput = false;
        attachCamera = false;
        rotateCamera = true;
        mouseWheel = true;
        toggleView = true;
        freeLooking = false;
        requireSprintButton = false;
        gravitationalForce = 3.0;
        minFallVelocity = 1.0;
        verticalStepSpeed = 1.0;
        minStepUpHeight = 0.15;
        rigidBodyMass = 85.0;
        airbornTimeout = 0.5;
        maxAngle = 45;
        speedFactor = 1.0;
        ...
        playerMouseY = 0;
        runKeyRequired = true;
        buttonRun = BABYLON.Xbox360Button.LeftStick;
        keyboardRun = TOOLKIT.UserInputKey.Shift;
        buttonJump = BABYLON.Xbox360Button.A;
        keyboardJump = TOOLKIT.UserInputKey.SpaceBar;
        buttonCamera = BABYLON.Xbox360Button.Y;
        keyboardCamera = TOOLKIT.UserInputKey.P;
        postNetworkAttributes = false;
        playerNumber = TOOLKIT.PlayerNumber.One;
        boomPosition = new BABYLON.Vector3(0, 0, 0);
        ...
        abstractMesh = null;
        cameraDistance = 0;
        forwardCamera = true; // Note Always Camera Forward
        avatarRadius = 0.5;
        groundingObject = null;
        groundingCallback = null;
        dollyDirection = new BABYLON.Vector3(0, 0, 0);
        cameraEulers = new BABYLON.Vector3(0, 0, 0);
        rotationEulers = new BABYLON.Vector3(0, 0, 0);
        cameraPivotOffset = new BABYLON.Vector3(0, 0, 0);
        cameraForwardVector = new BABYLON.Vector3(0, 0, 0);
        cameraRightVector = new BABYLON.Vector3(0, 0, 0);
        desiredForwardVector = new BABYLON.Vector3(0, 0, 0);
        desiredRightVector = new BABYLON.Vector3(0, 0, 0);
        lastRotationQuaternion = new BABYLON.Quaternion(0, 0, 0, 1);
        scaledCamDirection = new BABYLON.Vector3(0, 0, 0);
        scaledMaxDirection = new BABYLON.Vector3(0, 0, 0);
        parentNodePosition = new BABYLON.Vector3(0, 0, 0);
        maximumCameraPos = new BABYLON.Vector3(0, 0, 0);
        tempWorldPosition = new BABYLON.Vector3(0, 0, 0);
        cameraRaycastShape = null;
        defaultRaycastGroup = TOOLKIT.CollisionFilters.DefaultFilter;
        defaultRaycastMask = TOOLKIT.CollisionFilters.StaticFilter;
        cameraRaycastMask = (TOOLKIT.CollisionFilters.DefaultFilter | TOOLKIT.CollisionFilters.StaticFilter | TOOLKIT.CollisionFilters.KinematicFilter); // Note: Exclude The Player Character Controller From Camera Collision
        avatarSkins = null;
        cameraNode = null;
        cameraPivot = null;
        ...
        isCharacterFallTriggered = false;
        isCharacterJumpFrame = false;
        isCharacterJumping = false;
        isCharacterLanding = false;
        isCharacterRising = false;
        isCharacterNavigating = false;
        navigationAngularSpeed = 0;
        updateStateParams = true;
        animationStateParams = null;
        sphereCollisionShape = null;
        hasGroundedContact = false;
        showDebugRaycasts = false;
        showDebugColliders = false;
        colliderVisibility = 0;
        colliderRenderGroup = 0;
        deltaTime = 0;
        minJumpTimer = 0;
        delayJumpTimer = 0;
        playerControl = 0;
        ...
        lastJumpVelocity = new BABYLON.Vector3(0, 0, 0);
        inputMovementVector = new BABYLON.Vector3(0, 0, 0);
        playerLookRotation = new BABYLON.Vector3(0, 0, 0);
        playerRotationVector = BABYLON.Vector2.Zero();
        playerMovementVelocity = new BABYLON.Vector3(0, 0, 0);
        playerRotationQuaternion = BABYLON.Quaternion.Zero();
        playerMoveDirection = PROJECT.PlayerMoveDirection.Stationary;
        forwardDirection = new BABYLON.Vector3(0, 0, 1);
        downDirection = new BABYLON.Vector3(0, -1, 0);
        climbContact = false;
        climbContactNode = null;
        climbContactAngle = 0;
        climbContactPoint = new BABYLON.Vector3(0, 0, 0);
        climbContactNormal = new BABYLON.Vector3(0, 0, 0);
        climbContactDistance = 0;
        climbSensorLine = null;
        offsetClimbRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        startClimbRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        endClimbRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        heightContact = false;
        heightContactNode = null;
        heightContactAngle = 0;
        heightContactPoint = new BABYLON.Vector3(0, 0, 0);
        heightContactNormal = new BABYLON.Vector3(0, 0, 0);
        heightContactDistance = 0;
        heightSensorLine = null;
        offsetHeightRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        startHeightRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        endHeightRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        m_velocityOffset = new BABYLON.Vector3(0, 0, 0);
        m_actualVelocity = new BABYLON.Vector3(0, 0, 0);
        m_linearVelocity = new BABYLON.Vector3(0, 0, 0);
        m_lastPosition = new BABYLON.Vector3(0, 0, 0);
        m_positionCenter = new BABYLON.Vector3(0, 0, 0);
        m_scaledVelocity = 0;
        playerDrawVelocity = 0;
        constructor(transform, scene, properties) {
            super(transform, scene, properties);
        }
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        _deltaMotionPosition = new BABYLON.Vector3(0, 0, 0);
        ...
        _deltaMotionRotation = new BABYLON.Quaternion(0, 0, 0, 0);
        ...
        isRootMotionAction = false;
        isActionInterruptable = false;
        afterActionHandler = null;
        performActionTimer = 0;
        performActionNumber = 0;
        playerRotationSpeed = 10;
        rotatePlayerTowards = false;
        matchStartTime = 0;
        matchTargetTime = 0;
        matchTargetOffset = 0;
        matchTargetHeight = false;
        lockTargetHeight = false;
        lastStartHeight = null;
        lastTargetHeight = null;
        lastTargetNormal = new BABYLON.Vector3(0, 0, 0);
        lastTargetRotation = new BABYLON.Quaternion(0, 0, 0, 1);
        lastDeltaPosition = new BABYLON.Vector3(0, 0, 0);
        lastDeltaRotation = new BABYLON.Quaternion(0, 0, 0, 1);
            ...
            if (this.animationState != null && this.isRootMotionAction === true) {
                ...
                if (this.rotatePlayerTowards === true) {
                    if (this.climbContact === true) {
                        ...
                        TOOLKIT.Utilities.LookRotationToRef(this.lastTargetNormal, this.lastTargetRotation);
        ...
        attachPlayerCamera(player) {
            if (this.cameraNode == null) {
                ...
                if (this.cameraNode != null) {
                    ...
                    // ..
                    // const actualCamera:BABYLON.UniversalCamera = TOOLKIT.SceneManager.FindSceneCameraRig(this.cameraNode) as BABYLON.UniversalCamera;
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Controller Inverse Kineamatic Rigging
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ikLeftFootTarget = null;
        ikLeftPoleTarget = null;
        ikRightFootTarget = null;
        ikRightPoleTarget = null;
        abstractSkinMesh = null;
        rootBoneTransform = null;
        leftFootTransform = null;
        leftFootPoleOffset = new BABYLON.Vector3(-0.1, 0.5, 0.5);
        leftFootMaxAngle = 90;
        rightFootTransform = null;
        rightFootPoleOffset = new BABYLON.Vector3(0.1, 0.5, 0.5);
        rightFootMaxAngle = 90;
        ikLeftController = null;
        ikRightController = null;
        onAnimatorIK = null;
        getPlayerMesh() { return this.abstractSkinMesh; }
        getRootHipBone() { return (this.rootBoneTransform != null) ? this.rootBoneTransform._linkedBone : null; }
        getLeftFootBone() { return (this.leftFootTransform != null) ? this.leftFootTransform._linkedBone : null; }
        getRightFootBone() { return (this.rightFootTransform != null) ? this.rightFootTransform._linkedBone : null; }
        getLeftFootTarget() { return this.ikLeftFootTarget; }
        getRightFootTarget() { return this.ikRightFootTarget; }
        getLeftFootPoleTarget() { return this.ikLeftPoleTarget; }
        getRightFootPoleTarget() { return this.ikRightPoleTarget; }
        getRootBoneTransform() { return this.rootBoneTransform; }
        getLeftFootTransform() { return this.leftFootTransform; }
        getRightFootTransform() { return this.rightFootTransform; }
        getLeftFootController() { return this.ikLeftController; }
        getRightFootController() { return this.ikRightController; }
        isGroundedFootIKActive() { return (this.isCharacterGrounded === true && this.animationState != null && this.animationState.ikFrameEnabled()); }
        setupBoneControllers() {
            const createFootIKRig = this.getProperty("createFootIKRig");
            if (createFootIKRig === true) {
                ...
                if (abstractSkinMeshData != null)
                    this.abstractSkinMesh = this.getChildNode(abstractSkinMeshData.name, TOOLKIT.SearchType.ExactMatch, false);
                const rootBoneTransformData = this.getProperty("rootBoneTransform");
                if (rootBoneTransformData != null)
                    this.rootBoneTransform = this.getChildNode(rootBoneTransformData.name, TOOLKIT.SearchType.ExactMatch, false);
                // ..
                const leftFootTransformData = this.getProperty("leftFootTransform");
                if (leftFootTransformData != null)
                    this.leftFootTransform = this.getChildNode(leftFootTransformData.name, TOOLKIT.SearchType.ExactMatch, false);
                const leftPoleHandleData = this.getProperty("leftFootPoleOffset");
                if (leftPoleHandleData != null)
                    this.leftFootPoleOffset.copyFrom(TOOLKIT.Utilities.ParseVector3(leftPoleHandleData));
                ...
                if (rightFootTransformData != null)
                    this.rightFootTransform = this.getChildNode(rightFootTransformData.name, TOOLKIT.SearchType.ExactMatch, false);
                const rightPoleHandleData = this.getProperty("rightFootPoleOffset");
                if (rightPoleHandleData != null)
                    this.rightFootPoleOffset.copyFrom(TOOLKIT.Utilities.ParseVector3(rightPoleHandleData));
                this.rightFootMaxAngle = this.getProperty("rightFootMaxAngle", this.rightFootMaxAngle);
                // ..
                if (this.abstractSkinMesh != null && this.rootBoneTransform != null) {
                    ...
                    if (this.leftFootTransform != null && this.leftFootTransform._linkedBone != null) {
                        this.ikLeftFootTarget = BABYLON.MeshBuilder.CreateBox(this.transform.name + ".LeftFootTarget", { width: 0.1, height: 0.1, depth: 0.1 }, this.scene);
                        this.ikLeftFootTarget.parent = this.leftFootTransform;
                        this.ikLeftFootTarget.position.set(0, 0, 0);
                        this.ikLeftFootTarget.material = targetMaterial;
                        this.ikLeftFootTarget.isVisible = displayHandles;
                        // ..
                        this.ikLeftPoleTarget = BABYLON.MeshBuilder.CreateSphere(this.transform.name + ".LeftFootPole", { diameter: 0.1 }, this.scene);
                        this.ikLeftPoleTarget.parent = this.abstractSkinMesh;
                        this.ikLeftPoleTarget.position.copyFrom(this.leftFootPoleOffset);
                        this.ikLeftPoleTarget.isVisible = displayHandles;
                        // ..
                        // TODO: Setup Internal Left Foot Bone IK Controller
                        // this.ikLeftController = new BABYLON.BoneIKController();
                    }
                    // ..
                    // Setup Right Foot Controller
                    // ..
                    if (this.rightFootTransform != null && this.rightFootTransform._linkedBone != null) {
                        this.ikRightFootTarget = BABYLON.MeshBuilder.CreateBox(this.transform.name + ".RightFootTarget", { width: 0.1, height: 0.1, depth: 0.1 }, this.scene);
                        this.ikRightFootTarget.parent = this.rightFootTransform;
                        this.ikRightFootTarget.position.set(0, 0, 0);
                        this.ikRightFootTarget.material = targetMaterial;
                        this.ikRightFootTarget.isVisible = displayHandles;
                        // ..
                        this.ikRightPoleTarget = BABYLON.MeshBuilder.CreateSphere(this.transform.name + ".RightFootPole", { diameter: 0.1 }, this.scene);
                        this.ikRightPoleTarget.parent = this.abstractSkinMesh;
                        this.ikRightPoleTarget.position.copyFrom(this.rightFootPoleOffset);
                        this.ikRightPoleTarget.isVisible = displayHandles;
                        // ..
                        // TODO: Setup Internal Right Foot Bone IK Controller
                        // this.ikRightController = new BABYLON.BoneIKController();
                    }
                }
            }
        }
        attachAnimationController() {
            if (this.animationState == null) {
                this.animationState = this.getComponent("TOOLKIT.AnimationState", true);
            }
            if (this.animationState != null) {
                ...
                this.animationState.onAnimationUpdateObservable.add(() => {
                    if (this.onAnimatorIK != null) {
                        ...
                        this.updateAnimatorTargetMeshes();
                        if (this.ikLeftController != null) {
                            this.ikLeftController.update();
                        }
                        if (this.ikRightController != null) {
                            this.ikRightController.update();
                        }
                    }
                });
            }
        }
        updateAnimatorTargetMeshes() {
            // TODO: Do Raycast To Ground And Set IK Target Mesh Positions And Rotations
        }
        /** TODO */
        ...
        awakePlayerController() {
            ...
            if (boomPositionData != null)
                this.boomPosition = TOOLKIT.Utilities.ParseVector3(boomPositionData);
            // ..
            ...
            this.showDebugColliders = TOOLKIT.Utilities.ShowDebugColliders();
            this.colliderVisibility = TOOLKIT.Utilities.ColliderVisibility();
            this.colliderRenderGroup = TOOLKIT.Utilities.ColliderRenderGroup();
            ...
            // ..
            const configController = this.getComponent("TOOLKIT.CharacterController");
            // ..
            // Setup IK Bone Controllers
            // ..
            this.setupBoneControllers();
            // ..
            TOOLKIT.InputController.OnKeyboardPress(this.keyboardCamera, () => { this.togglePlayerControl(); });
            TOOLKIT.InputController.OnGamepadButtonPress(this.buttonCamera, () => { this.togglePlayerControl(); });
        }
        startPlayerController() {
            ...
            this.navigationAgent = this.getComponent("TOOLKIT.NavigationAgent");
            this.characterController = this.getComponent("TOOLKIT.CharacterController");
            if (this.characterController != null) {
                ...
                TOOLKIT.SceneManager.LogWarning("Starting player controller in physic engine mode for: " + this.transform.name);
            }
            else {
                TOOLKIT.SceneManager.LogWarning("No character controller found for: " + this.transform.name);
            }
            // Set player window state variable
            // TOOLKIT.SceneManager.SetWindowState("player", this);
        }
        ...
        updatePlayerController() {
            ...
            //this.smoothDeltaTime = TOOLKIT.System.SmoothDeltaFactor * this.deltaTime + (1 - TOOLKIT.System.SmoothDeltaFactor) * this.smoothDeltaTime;
            // ..
            ...
            if (this.enableInput === false)
                return;
            const userInputX = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.Horizontal, this.playerNumber);
            const userInputZ = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.Vertical, this.playerNumber);
            const userMouseX = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.MouseX, this.playerNumber);
            const userMouseY = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.MouseY, this.playerNumber);
            ...
            // ..
            this.isRunPressed = (TOOLKIT.InputController.GetKeyboardInput(this.keyboardRun) || TOOLKIT.InputController.GetGamepadButtonInput(this.buttonRun));
            this.isJumpPressed = (TOOLKIT.InputController.GetKeyboardInput(this.keyboardJump) || TOOLKIT.InputController.GetGamepadButtonInput(this.buttonJump));
            // ..
            ...
            // ..
            if (this.postNetworkAttributes == true && TOOLKIT.EntityController.HasNetworkEntity(this.transform)) {
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 0, this.playerMoveDirection); // Direction
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 1, this.inputMagnitude); // Magnitude
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 2, this.playerInputX); // Horizonal
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 3, this.playerInputZ); // Vertical
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 4, this.playerMouseX); // MouseX
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 5, this.playerMouseY); // MouseY
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 6, this.verticalVelocity); // Vertical Velocity
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 7, this.movementSpeed); // Movement Speed
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 8, this.performActionNumber); // Action State
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 9, ((this.isCharacterJumpFrame) ? 1 : 0)); // Jump Frame
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 10, ((this.isCharacterJumping) ? 1 : 0)); // Is Jumping
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 11, ((this.isCharacterFalling) ? 1 : 0)); // Is Falling
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 12, ((this.isCharacterSliding) ? 1 : 0)); // Is Sliding
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 13, ((this.isCharacterGrounded) ? 1 : 0)); // Is Grounded
            }
            // ..
        ...
        updateCharacterController() {
            if (this.characterController != null) {
                ...
                // TOOLKIT.WindowManager.PrintToScreen("Is Grounded: " + this.isCharacterGrounded);
                // ..
        ...
        updateCameraController() {
            ...
            if (this.cameraPivot != null) {
                ...
                // Update Camera Pivot Position
                // ..
                TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.cameraPivot.position, this.cameraPivotOffset);
                // ..
                // Update Camera Pivot Rotation
                // ..
                ...
                if (this.playerControl === PROJECT.PlayerInputControl.ThirdPersonStrafing) {
                    if (this.cameraCollisions === true) {
                        ...
                        if (this.characterController != null) {
                            ...
                            TOOLKIT.RigidbodyPhysics.RaycastToRef(this.parentNodePosition, this.maximumCameraPos, this.cameraRaycastResult);
                            ...
                            //TOOLKIT.WindowManager.PrintToScreen("Camera Collision: " + contact + " --> Distance:  " + distance + " --> Transform: " + contactBody);*/
                        }
                        if (contact === true) {
        ...
        castPhysicsClimbingVolumeRay() {
            ...
            // ..
            const playerTransformForwardDirection = TOOLKIT.Utilities.TransformDirection(this.transform, this.forwardDirection);
            this.offsetClimbRaycastPosition.set(0, this.rayClimbOffset, 0);
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.startClimbRaycastPosition, this.offsetClimbRaycastPosition);
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.endClimbRaycastPosition, this.forwardDirection.scale(this.rayClimbLength));
            this.endClimbRaycastPosition.y += this.rayClimbOffset;
            // ..
            //raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycast(this.scene, this.startClimbRaycastPosition, playerTransformForwardDirection, this.rayClimbLength, this.defaultRaycastGroup, this.defaultRaycastMask);
            if (raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                const checkTag = TOOLKIT.SceneManager.GetTransformTag(raycast.collisionObject.entity);
                if (checkTag === this.climbVolumeTag) {
                    ...
                    this.climbContactAngle = (this.climbContactNormal != null) ? Math.abs(TOOLKIT.Utilities.GetAngle(this.climbContactNormal, BABYLON.Vector3.UpReadOnly)) : 0;
            ...
            if (this.showDebugColliders === true) {
                if (this.climbSensorLine == null)
                    this.climbSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".ClimbingSensorLine", this.scene);
                if (this.climbContact === true) {
        ...
        castPhysicsHeightCheckVolumeRay() {
            ...
            // ..
            const playerTransformHeightDirection = TOOLKIT.Utilities.TransformDirection(this.transform, this.downDirection);
            if (this.climbContact === true) {
                ...
                //raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycast(this.scene, this.startHeightRaycastPosition, playerTransformHeightDirection, this.rayHeightLength, this.defaultRaycastGroup, this.defaultRaycastMask);
            }
            else {
                this.offsetHeightRaycastPosition.set(0, this.rayHeightOffset, this.rayClimbLength);
                TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.startHeightRaycastPosition, this.offsetHeightRaycastPosition);
            ...
            if (raycast != null && raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                ...
                if (checkTag === this.climbVolumeTag) {
                    ...
                    this.heightContactAngle = (this.heightContactNormal != null) ? Math.abs(TOOLKIT.Utilities.GetAngle(this.heightContactNormal, BABYLON.Vector3.UpReadOnly)) : 0;
            ...
            if (this.showDebugColliders === true) {
                if (this.heightSensorLine == null)
                    this.heightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".HeightCheckSensorLine", this.scene);
...
(function (PROJECT) {
    ...
    */
    class ThirdPersonPlayerController extends TOOLKIT.ScriptComponent {
        ...
        canPlayerJump = true;
        animationState = null;
        // DEPRECATED: private rotationVelocityX:BABYLON.Vector2 = new BABYLON.Vector2(0,0);
        // DEPRECATED: private rotationVelocityY:BABYLON.Vector2 = new BABYLON.Vector2(0,0);
        lastJumpVelocity = new BABYLON.Vector3(0, 0, 0);
        inputMovementVector = new BABYLON.Vector3(0, 0, 0);
        playerLookRotation = new BABYLON.Vector3(0, 0, 0);
        playerMovementVelocity = new BABYLON.Vector3(0, 0, 0);
        ...
        //private defaultRaycastGroup:number = TOOLKIT.CollisionFilters.DefaultFilter;
        //private defaultRaycastMask:number = TOOLKIT.CollisionFilters.StaticFilter;
        //private cameraRaycastMask:number = (TOOLKIT.CollisionFilters.DefaultFilter | TOOLKIT.CollisionFilters.StaticFilter | TOOLKIT.CollisionFilters.KinematicFilter); // Note: Exclude The Player Character Controller From Camera Collision

        public attachPlayerCamera(player: TOOLKIT.PlayerNumber): void {
            if (this.cameraNode == null) {
        ...
        */
        ...
        startPlayerController() {
            // TODO - Support Dynamic PlayerNumber Change - ???
            if (this.attachCamera === true) {
                PROJECT.DefaultCameraSystem.SetAutoUpdate(false);
                PROJECT.DefaultCameraSystem.SetFollowTarget(this.transform);
            }
            this.navigationAgent = this.getComponent("TOOLKIT.NavigationAgent");
            this.characterController = this.getComponent("TOOLKIT.CharacterController");
            if (this.characterController != null) {
                this.avatarRadius = this.characterController.getAvatarRadius();
                this.characterController.showRaycasts = this.showDebugRaycasts;
                this.characterController.raycastLength = this.raycastLength;
                this.characterController.setRigidBodyMass(this.rigidBodyMass);
                this.characterController.setGravityFactor(this.gravitationalForce);
                this.characterController.setVerticalStepSpeed(this.verticalStepSpeed);
                this.characterController.setMinimumStepHeight(this.minStepUpHeight);
        ...
        updatePlayerController() {
            this.deltaTime = this.getDeltaSeconds();
            if (!this.isReady())
                return; // Note: Wait For Scene Ready
            // ..
            this.m_actualVelocity = this.transform.absolutePosition.subtract(this.m_lastPosition);
            this.m_linearVelocity.copyFrom(this.m_actualVelocity);
            this.m_scaledVelocity = (this.m_linearVelocity.length() / this.deltaTime);
            ...
            if (this.freeCamera == null)
                this.freeCamera = this.scene.activeCamera;
            ...
            if (this.movementAllowed == true) {
                if (this.inputMagnitude > 0) {
                    ...
                    // ..
                    // SNAP TO: TOOLKIT.Utilities.LookRotationToRef(this.playerLookRotation, this.transform.rotationQuaternion);
                    // ..
            ...
            if (this.postNetworkAttributes == true && TOOLKIT.EntityController.HasNetworkEntity(this.transform)) {
                ...
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 5, this.playerMouseY); // MouseY
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 6, this.verticalVelocity); // Vertical Velocity
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 7, this.animationSpeed); // Movement Speed
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 8, this.performActionNumber); // Action State
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 9, ((this.isCharacterJumpFrame) ? 1 : 0)); // Jump Frame
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 10, ((this.isCharacterJumping) ? 1 : 0)); // Is Jumping
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 11, ((this.isCharacterFalling) ? 1 : 0)); // Is Falling
        ...
        updateCharacterController() {
            if (this.characterController != null) {
                ...
                // console.log(msgx);
                // TOOLKIT.WindowManager.PrintToScreen(msgx);
                // ..
                // Update Climbing System
                // ..
                if (this.useClimbSystem === true) {
    ...
    */
    class AutoBodyGarage extends TOOLKIT.ScriptComponent {
        ...
        awake() {
            ...
            const mainBodyPaintColor = TOOLKIT.Utilities.ParseColor3(mainBodyUnityColor, BABYLON.Color3.White());
            if (mainBodyTransform != null) {
                this.m_bodyAbtractMesh = TOOLKIT.Utilities.ParseChildTransform(this.transform, mainBodyTransform);
                if (this.m_bodyAbtractMesh != null) {
                    ...
                    TOOLKIT.SceneManager.LogWarning("Failed to find auto body mesh for: " + this.transform.name);
                }
            }
        }
    ...
    */
    class CheckpointManager extends TOOLKIT.ScriptComponent {
                        ...
                        if (nextCheckpointMesh.intersectsPoint(this.transform.absolutePosition)) {
                            ...
                            if (this.checkPointIndex === 0) {
                                if (this.lapNumber > 0 && this.lapTimer > 0) {
                                    const lapTime = (TOOLKIT.SceneManager.GetGameTime() - this.lapTimer);
                                    if (this.lapTimes == null)
                                        this.lapTimes = [];
                                    this.lapTimes.push(lapTime);
                                }
                                this.lapNumber++;
                                this.lapTimer = TOOLKIT.SceneManager.GetGameTime();
        ...
        late() {
            ...
            //    TOOLKIT.Utilities.PrintToScreen("Checkpoint Index: " + this.checkPointIndex.toString() + " ---> Next: " + this.nextCheckPointName);
            // }
            if (this.raceOver === false) {
                if (this.startRaceTime > 0) {
                    this.totalRaceTime = (TOOLKIT.SceneManager.GetGameTime() - this.startRaceTime);
                }
                if (this.playerID > 0) {
        ...
        startRaceTimer() {
            if (this.startRaceTime === 0) {
                this.lapTimes = [];
                this.raceOver = false;
                this.startRaceTime = TOOLKIT.SceneManager.GetGameTime();
            }
        }
    }
...
(function (PROJECT) {
    ...
    */
    class NetworkCarPrediction extends TOOLKIT.ScriptComponent {
        autoRegister = true;
        handlerName = "VehiclePrediction";
        extrapolateTimeMs = 200;
        awake() {
        ...
        LegacyHandleUpdate(networkEntity, remoteTransform, deltaTime) {
            ...
            // ..
            TOOLKIT.Utilities.QuaternionDiffToRef((<any>remoteTransform).networkEntityCurrRotation, (<any>remoteTransform).networkEntityPrevRotation, (<any>remoteTransform).networkEntityDeltaRotation);
            ...
            */
            if (entityDeltaTimeMs <= this.extrapolateTimeMs && entityElaspedTimeMs <= this.extrapolateTimeMs) {
                ...
                // const extra = TOOLKIT.Utilities.MultiplyQuaternionByVector(quat, linearVelocity);
                // ..
                ...
                //TOOLKIT.Utilities.MoveTowardsVector3ToRef(remoteTransform.position, networkPosition, metersPerSecond, remoteTransform.position);
                // ..
...
(function (PROJECT) {
    ...
    */
    class RaceTrackManager extends TOOLKIT.ScriptComponent {
        static TrackLength = 0;
        static TotalLapCount = 3;
        static WinnerTransform = null;
        static CheckPointTag = "Checkpoint";
        static CheckPointList = null;
        static LeaderBoardList = null;
        static PlayerVehicleList = null;
        trackNodes = null;
        raceLineData_1 = null;
        raceLineData_2 = null;
        raceLineData_3 = null;
        raceLineData_4 = null;
        raceLineData_5 = null;
        raceLineColor_1 = null;
        raceLineColor_2 = null;
        raceLineColor_3 = null;
        raceLineColor_4 = null;
        raceLineColor_5 = null;
        debugMeshLines_1 = null;
        debugMeshLines_2 = null;
        debugMeshLines_3 = null;
        debugMeshLines_4 = null;
        debugMeshLines_5 = null;
        p0n = 0;
        p1n = 0;
        p2n = 0;
        p3n = 0;
        ...
        static get EventBus() {
            if (PROJECT.RaceTrackManager._EventBus == null) {
                PROJECT.RaceTrackManager._EventBus = new TOOLKIT.LocalMessageBus();
            }
        ...
        awake() {
            ...
            if (this.trackNodes != null) {
                ...
                for (index = 0; index < this.trackNodes.length; index++) {
                    ...
                    if (t1 != null && t2 != null) {
                        const rot = TOOLKIT.Utilities.ParseVector4(element.rotation);
                        element.localRotation = new BABYLON.Quaternion(rot.x, rot.y, rot.z, rot.w);
                        element.localPosition = TOOLKIT.Utilities.ParseVector3(element.position);
                        const p1 = TOOLKIT.Utilities.ParseVector3(t1.position);
                        const p2 = TOOLKIT.Utilities.ParseVector3(t2.position);
            ...
            if (this.drawDebugLines === true) {
                ...
                if (this.trackNodes != null && this.trackNodes.length > 0) {
                    ...
                    this.trackNodes.forEach((node) => {
                        ...
                        trackNode.rotationQuaternion = trackNodeRotation.multiply(TOOLKIT.Utilities.FromEuler(90, 0, 0));
...
(function (PROJECT) {
    ...
    */
    class RemoteCarController extends TOOLKIT.ScriptComponent {
        static ShowSensorLines = false; // Note: Disable Debug Mode Sensors
        centerOfMass = 0.4;
        burnoutWheelPitch = 0.85;
        linkTrackManager = true;
        playVehicleSounds = true;
        smokeTexture = null;
        skidThreashold = 0.65;
        smokeIntensity = 150;
        wheelDrawVelocity = 0.02;
        smokeOpacity = 0.1;
        smokeDonuts = 2.0;
        steeringWheelHub = null;
        steeringWheelAxis = 2;
        maxSteeringAngle = 35.0;
        maxSteeringSpeed = 10.0;
        _animator = null;
        _engineAudioSource = null;
        _skidAudioSource = null;
        brakeLightsMesh = null;
        brakeLightsTrans = null;
        reverseLightsMesh = null;
        reverseLightsTrans = null;
        frontLeftWheelTrans = null;
        frontRightWheelTrans = null;
        backLeftWheelTrans = null;
        backRightWheelTrans = null;
        frontLeftWheelMesh = null;
        frontRightWheelMesh = null;
        backLeftWheelMesh = null;
        backRightWheelMesh = null;
        frontLeftWheelEmitter = null;
        frontRightWheelEmitter = null;
        backLeftWheelEmitter = null;
        backRightWheelEmitter = null;
        frontLeftWheelParticle = null;
        frontRightWheelParticle = null;
        backLeftWheelParticle = null;
        backRightWheelParticle = null;
        frontLeftContact = false;
        frontRightContact = false;
        rearLeftContact = false;
        rearRightContact = false;
        frontLeftContactTag = "";
        frontRightContactTag = "";
        rearLeftContactTag = "";
        rearRightContactTag = "";
        frontLeftContactPoint = new BABYLON.Vector3(0, 0, 0);
        frontRightContactPoint = new BABYLON.Vector3(0, 0, 0);
        rearLeftContactPoint = new BABYLON.Vector3(0, 0, 0);
        rearRightContactPoint = new BABYLON.Vector3(0, 0, 0);
        frontLeftContactNormal = new BABYLON.Vector3(0, 0, 0);
        frontRightContactNormal = new BABYLON.Vector3(0, 0, 0);
        rearLeftContactNormal = new BABYLON.Vector3(0, 0, 0);
        rearRightContactNormal = new BABYLON.Vector3(0, 0, 0);
        frontLeftSensorLine = null;
        frontRightSensorLine = null;
        rearLeftSensorLine = null;
        rearRightSensorLine = null;
        startRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        endRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        smokeIntensityFactor = 0;
        downDirection = new BABYLON.Vector3(0, -1, 0);
        downDistance = 2.0;
        lastPitch = 0;
        lastBrake = 0;
        ...
        m_frontLeftWheelSkid = -1;
        m_frontRightWheelSkid = -1;
        m_backLeftWheelSkid = -1;
        m_backRightWheelSkid = -1;
        m_velocityOffset = new BABYLON.Vector3(0, 0, 0);
        m_linearVelocity = new BABYLON.Vector3(0, 0, 0);
        m_lastPosition = new BABYLON.Vector3(0, 0, 0);
        m_positionCenter = new BABYLON.Vector3(0, 0, 0);
        ...
        awake() {
            ...
            if (smokeTextureInfo != null) {
                this.smokeTexture = TOOLKIT.Utilities.ParseTexture(smokeTextureInfo, this.scene);
            }
            if (this.linkTrackManager === true)
                PROJECT.RaceTrackManager.RegisterVehicle(this.transform);
            this._animator = this.getComponent("TOOLKIT.AnimationState");
            if (this._animator == null) {
                const animationNode = this.getChildWithScript("TOOLKIT.AnimationState");
                if (animationNode != null) {
                    this._animator = TOOLKIT.SceneManager.FindScriptComponent(animationNode, "TOOLKIT.AnimationState");
                }
                else {
                    // DEBUG: TOOLKIT.SceneManager.LogWarning("Failed to locate animator node for: " + this.transform);
                }
            }
            this._engineAudioSource = this.getComponent("TOOLKIT.AudioSource");
            if (this._engineAudioSource == null)
                TOOLKIT.SceneManager.LogWarning("No engine audio source manager found for: " + this.transform.name);
            ...
            if (steeringWheelNode != null && steeringWheelNode.name != null && steeringWheelNode.name !== "") {
                this.steeringWheelHub = this.getChildNode(steeringWheelNode.name, TOOLKIT.SearchType.IndexOf, false);
            }
            ...
            if (brakeLightslName != null) {
                this.brakeLightsMesh = this.getChildNode(brakeLightslName, TOOLKIT.SearchType.IndexOf, false);
                if (this.brakeLightsMesh != null) {
                    this.brakeLightsMesh.isVisible = false;
                }
            }
            if (reverseLightslName != null) {
                this.reverseLightsMesh = this.getChildNode(reverseLightslName, TOOLKIT.SearchType.IndexOf, false);
                if (this.reverseLightsMesh != null) {
                    this.reverseLightsMesh.isVisible = false;
                }
            }
            this.frontLeftWheelMesh = this.getChildNode(frontLeftWheelName, TOOLKIT.SearchType.IndexOf, false);
            if (this.frontLeftWheelMesh != null) {
                this.frontLeftWheelMesh.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.frontLeftWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
            ...
            this.frontRightWheelMesh = this.getChildNode(frontRightWheelName, TOOLKIT.SearchType.IndexOf, false);
            if (this.frontRightWheelMesh != null) {
                this.frontRightWheelMesh.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.frontRightWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
            ...
            this.backLeftWheelMesh = this.getChildNode(backLeftWheelName, TOOLKIT.SearchType.IndexOf, false);
            if (this.backLeftWheelMesh != null) {
                this.backLeftWheelMesh.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.backLeftWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
            ...
            this.backRightWheelMesh = this.getChildNode(backRightWheelName, TOOLKIT.SearchType.IndexOf, false);
            if (this.backRightWheelMesh != null) {
                this.backRightWheelMesh.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.backRightWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
            ...
            if (this._skidAudioSource == null && this.backRightWheelMesh != null)
                this._skidAudioSource = TOOLKIT.SceneManager.FindScriptComponent(this.backRightWheelMesh, "TOOLKIT.AudioSource");
            if (this._skidAudioSource == null && this.backLeftWheelMesh != null)
                this._skidAudioSource = TOOLKIT.SceneManager.FindScriptComponent(this.backLeftWheelMesh, "TOOLKIT.AudioSource");
            if (this._skidAudioSource == null && this.frontRightWheelMesh != null)
                this._skidAudioSource = TOOLKIT.SceneManager.FindScriptComponent(this.frontRightWheelMesh, "TOOLKIT.AudioSource");
            if (this._skidAudioSource == null && this.frontLeftWheelMesh != null)
                this._skidAudioSource = TOOLKIT.SceneManager.FindScriptComponent(this.frontLeftWheelMesh, "TOOLKIT.AudioSource");
            if (this._skidAudioSource == null)
                TOOLKIT.SceneManager.LogWarning("No skid audio source manager found for: " + this.transform.name);
        }
        start() {
        ...
        update() {
            if (TOOLKIT.EntityController.HasNetworkEntity(this.transform)) {
                this.lastPitch = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 0); // Pitch
                this.lastBrake = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 1); // Brake
                this.lastReverse = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 2); // Reverse
                this.lastBurnout = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 3); // Burnout
                this.lastSKID_FL = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 4); // SKID_FL
                this.lastSKID_FR = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 5); // SKID_FR
                this.lastSKID_RL = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 6); // SKID_RL
                this.lastSKID_RR = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 7); // SKID_RR
                this.lastSPIN_FL = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 8); // SPIN_FL
                this.lastSPIN_FR = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 9); // SPIN_FR
                this.lastSPIN_RL = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 10); // SPIN_RL
                this.lastSPIN_RR = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 11); // SPIN_RR
                this.lastSteering = TOOLKIT.EntityController.QueryBufferedAttribute(this.transform, 12); // Steering
            }
        ...
        updateVehicleProperties() {
            //TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.transform.position, this.m_positionCenter); // Note: This Correct Center Of Mass Offset
            ...
            if (this.playVehicleSounds === true) {
                if (this._engineAudioSource != null) {
                    this._engineAudioSource.setPitch(this.lastPitch);
                }
            }
            // ..
            // Update Wheel Spinners
            // ..
            ...
            if (this.playVehicleSounds === true) {
                if (this._skidAudioSource != null) {
                    this._skidAudioSource.setPitch(this.WHEEL_SKID_PITCH);
                }
            }
            ///////////////////////////////////////////
        ...
        castWheelContactRays() {
            ...
            // ..
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.frontLeftWheelMesh, this.startRaycastPosition);
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.frontLeftWheelMesh, this.endRaycastPosition, this.downDirection.scale(this.downDistance));
            ...
            // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycast(this.scene, this.startRaycastPosition, this.downDirection, this.downDistance);
            if (raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                this.frontLeftContact = true;
                this.frontLeftContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.collisionObject.entity);
            ...
            if (PROJECT.RemoteCarController.ShowSensorLines === true) {
                if (this.frontLeftSensorLine == null)
                    this.frontLeftSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".FrontLeftSensorLine", this.scene);
            ...
            // ..
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.frontRightWheelMesh, this.startRaycastPosition);
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.frontRightWheelMesh, this.endRaycastPosition, this.downDirection.scale(this.downDistance));
            this.startRaycastPosition.addInPlace(this.m_velocityOffset);
            this.endRaycastPosition.addInPlace(this.m_velocityOffset);
            ...
            if (raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                ...
                this.frontRightContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.collisionObject.entity);
            ...
            if (PROJECT.RemoteCarController.ShowSensorLines === true) {
                if (this.frontRightSensorLine == null)
                    this.frontRightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".FrontRightSensorLine", this.scene);
            ...
            // ..
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.backLeftWheelMesh, this.startRaycastPosition);
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.backLeftWheelMesh, this.endRaycastPosition, this.downDirection.scale(this.downDistance));
            this.startRaycastPosition.addInPlace(this.m_velocityOffset);
            this.endRaycastPosition.addInPlace(this.m_velocityOffset);
            ...
            if (raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                ...
                this.rearLeftContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.collisionObject.entity);
            ...
            if (PROJECT.RemoteCarController.ShowSensorLines === true) {
                if (this.rearLeftSensorLine == null)
                    this.rearLeftSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".RearLeftSensorLine", this.scene);
            ...
            // ..
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.backRightWheelMesh, this.startRaycastPosition);
            TOOLKIT.Utilities.GetAbsolutePositionToRef(this.backRightWheelMesh, this.endRaycastPosition, this.downDirection.scale(this.downDistance));
            this.startRaycastPosition.addInPlace(this.m_velocityOffset);
            this.endRaycastPosition.addInPlace(this.m_velocityOffset);
            ...
            if (raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                ...
                this.rearRightContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.collisionObject.entity);
            ...
            if (PROJECT.RemoteCarController.ShowSensorLines === true) {
                if (this.rearRightSensorLine == null)
                    this.rearRightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".RearRightSensorLine", this.scene);
...
(function (PROJECT) {
    ...
    class SkidMarkSection {
        ...
        Tangent = BABYLON.Vector4.Zero();
        Posl = BABYLON.Vector3.Zero();
        Posr = BABYLON.Vector3.Zero();
        Intensity = 0.0;
        LastIndex = -1;
    }
    ...
    class SkidMarkManager extends TOOLKIT.ScriptComponent {
        static MAX_MARKS = 1024; // Max number of marks total for everyone together
        static GROUND_OFFSET = 0.01; // Distance above surface in metres
        static GPU_TRIANGLES = true; // GPU quad triangle indices only
        static MARK_COLOR = BABYLON.Color3.Black(); // SkidMark Color
        static MARK_WIDTH = 0.3; // Width of the SkidMarks. Should match the width of the wheels
        static TEX_INTENSITY = 1.0; // Amount of the skidmark texture intensity coeffecient
        static MIN_DISTANCE = 0.1; // Distance between skid texture sections in metres. Bigger = better performance, less smooth
        static MIN_SQR_DISTANCE = (SkidMarkManager.MIN_DISTANCE * SkidMarkManager.MIN_DISTANCE);
        static TEXTURE_MARKS = null;
        static SkidBufferPositions = null;
        static SkidBufferNormals = null;
        static SkidBufferTangents = null;
        static SkidBufferColors = null;
        static SkidBufferUvs = null;
        static SkidBufferIndices = null;
        static SkidMarkSections = null;
        static SkidMarkIndex = 0;
        static SkidMarkMesh = null;
        static SkidMarkUpdated = false;
        static TempVector3_POS = new BABYLON.Vector3(0, 0, 0);
        static TempVector3_DIR = new BABYLON.Vector3(0, 0, 0);
        static TempVector3_XDIR = new BABYLON.Vector3(0, 0, 0);
        static TempVector3_SDIR = new BABYLON.Vector3(0, 0, 0);
        constructor(transform, scene, properties = {}) {
            super(transform, scene, properties);
            SkidMarkManager.MAX_MARKS = this.getProperty("maxSections", SkidMarkManager.MAX_MARKS);
            SkidMarkManager.MARK_COLOR = TOOLKIT.Utilities.ParseColor3(this.getProperty("textureColor"), SkidMarkManager.MARK_COLOR);
        ...
        static CreateSkidMarkManager(scene) {
            if (SkidMarkManager.SkidMarkMesh == null) {
                ...
                skidmarkMaterial.diffuseTexture = TOOLKIT.Utilities.ParseTexture(SkidMarkManager.TEXTURE_MARKS, scene);
                ...
                SkidMarkManager.SkidMarkMesh.renderingGroupId = TOOLKIT.Utilities.DefaultRenderGroup();
...
(function (PROJECT) {
    ...
    class StandardCarController extends TOOLKIT.ScriptComponent {
        static DEFAULT_SKID_FACTOR = 1.0;
        static DEFAULT_PITCH_FACTOR = 1.0;
        static DEFAULT_SPEED_FACTOR = 1.0;
        static DEFAULT_DONUT_FACTOR = 1.0;
        static SimplexNoise2D = TOOLKIT.Simplex.createNoise2D();
        MIN_RPM = 1000;
        MAX_RPM = 6000;
        _animator = null;
        _rigidbody = null;
        _engineAudioSource = null;
        _skidAudioSource = null;
        _nosAudioSource = null;
        _skidExtraRotation = new BABYLON.Vector3(0, 0, 0);
        _donutExtraRotation = new BABYLON.Vector3(0, 0, 0);
        steeringWheelHub = null;
        steeringWheelAxis = 2;
        maxSteeringAngle = 65.0;
        maxSteeringSpeed = 15.0;
        gearIndex = 0; // First Gear Ratio
        downShift = 1000;
        skiddingTime = 0;
        shiftingTime = 0;
        shiftingSide = 1;
        ...
        physicsSteerAngleL = 0;
        physicsSteerAngleR = 0;
        visualSteerAngleL = 0;
        visualSteerAngleR = 0;
        visualSteerBoostL = 0;
        visualSteerBoostR = 0;
        ...
        WHEEL_SKID_PITCH = 0;
        POWER_BOOST_PITCH = 0;
        SPIN_FL_Rotation = new BABYLON.Vector3(0, 0, 0);
        SPIN_FR_Rotation = new BABYLON.Vector3(0, 0, 0);
        SPIN_RL_Rotation = new BABYLON.Vector3(0, 0, 0);
        SPIN_RR_Rotation = new BABYLON.Vector3(0, 0, 0);
        ...
        noiseTimeScale = 1.0;
        noiseTimeFactor = 0;
        maxBurnoutFactor = 1.0;
        maxSteerBoost = 6;
        overSteerSpeed = 1.0;
        overSteerTimeout = 0.2;
        topEngineSpeed = 100;
        topBoosterSpeed = 150;
        powerChangeRate = 5.0;
        powerCoefficient = 1.0;
        boosterCoefficient = 1.0;
        frictionLerpSpeed = 0.5;
        topSpeedDampener = 0.15;
        lowSpeedSteering = 5.0;
        highSpeedSteering = 5.0;
        donutTurningRadius = 3.0;
        donutEngineFactor = 1.5;
        donutRotateFactor = 2.5;
        donutLerpingSpeed = 1.0;
        ...
        smoothFlyingForce = 250;
        transmissionRatio = 0.75;
        differentialRatio = 3.55;
        minBoosterSpeed = 25.0;
        maxBoosterTime = 10.0;
        maxPitchControl = 0.1;
        maxFrontBraking = 0.0;
        maxReversePower = 0.5;
        minBrakingForce = 50;
        maxBrakingForce = 250;
        handBrakingForce = 2500;
        handBrakingTimer = 0;
        skidRotationTimeout = 1.0;
        linearBrakingForce = 15.0;
        angularBrakingForce = 1.0;
        burnoutFrictionSlip = 1.0;
        burnoutTimeDelay = 1;
        burnoutWheelPitch = 0.85;
        burnoutCoefficient = 15;
        burnoutTriggerMark = 10;
        enableAutoBurnouts = false;
        driftTriggerAngle = 30.0;
        driftTriggerSpeed = 30.0;
        enableAutoDrifting = false;
        penaltyGroundTag = "Offroad";
        minPenaltySpeed = 65;
        linearWheelDrag = 0.05;
        frictionWheelSlip = 0.215;
        showSensorLines = false;
        powerBooster = false;
        linkTrackManager = true;
        playVehicleSounds = true;
        postNetworkAttributes = false;
        wheelDriveType = 0;
        gearBoxMultiplier = 1.0;
        gearBoxMaxPitching = 6500;
        gearBoxShiftChange = 5100;
        gearBoxShiftDelay = 0.35;
        gearBoxShiftRatios = [4.17, 2.34, 1.82, 1.54, 0.96, 0.68];
        gearBoxShiftRanges = [1000, 2400, 2600, 2600, 2800, 2800];
        throttleBrakingForce = 0;
        throttleEngineSpeed = 0;
        brakeRecoveryDelay = 0.05;
        brakeRecoverySpeed = 0.35;
        skidRecoverySpeed = 0.25;
        extraRotationSpeed = 0.1;
        maxRotationSpeed = 2.0;
        burnoutLerpSpeed = 0.05;
        ackermanWheelBase = 2.5;
        ackermanRearTrack = 1.5;
        ackermanTurnRadius = 9;
        ackermanMaxRadius = 18;
        ackermanTurnFactor = 1;
        ...
        movementTilting = false;
        surfaceDetection = false;
        idleShakeRate = 5.0;
        idleShakeNoise = 0.01;
        maxForwardAngle = 3.0;
        maxLateralAngle = 3.0;
        lerpForwardFactor = 10.0;
        lerpLateralFactor = 10.0;
        shiftForwardExtra = 0.2;
        shiftLateralExtra = 0.2;
        forwardPitchFactor = 0.2;
        lateralRollFactor = 0.2;
        forwardRecoverRate = 0.2;
        lateralRecoverRate = 0.2;
        lowSpeedScale = 1.0;
        highSpeedScale = 5.0;
        lowForwardNoise = 0.05;
        highForwardNoise = 0.05;
        lowLateralNoise = 0.05;
        highLateralNoise = 0.05;
        speedThreashold = 5.0;
        boosterTransform = null;
        chassisTransform = null;
        tiltChassisEulers = new BABYLON.Vector3(0, 0, 0);
        ...
        m_backLeftWheel = null;
        m_backRightWheel = null;
        m_frontLeftWheelSkid = -1;
        m_frontRightWheelSkid = -1;
        m_backLeftWheelSkid = -1;
        m_backRightWheelSkid = -1;
        m_angularDampener = new BABYLON.Vector3(1.0, 1.0, 1.0);
        m_velocityOffset = new BABYLON.Vector3(0, 0, 0);
        m_linearVelocity = new BABYLON.Vector3(0, 0, 0);
        m_lastPosition = new BABYLON.Vector3(0, 0, 0);
        m_scaledVelocity = 0;
        ...
        awakeVehicleState() {
            ...
            if (vehicleChassisTransform != null && vehicleChassisTransform.name != null && vehicleChassisTransform.name !== "") {
                this.chassisTransform = this.getChildNode(vehicleChassisTransform.name, TOOLKIT.SearchType.IndexOf, false);
            }
            ...
            if (powerBoosterTransform != null && powerBoosterTransform.name != null && powerBoosterTransform.name !== "") {
                this.boosterTransform = this.getChildNode(powerBoosterTransform.name, TOOLKIT.SearchType.IndexOf, false);
                if (this.boosterTransform != null)
                    this._nosAudioSource = TOOLKIT.SceneManager.FindScriptComponent(this.boosterTransform, "TOOLKIT.AudioSource");
            }
            const steeringWheelNode = this.getProperty("steeringWheelHub");
            if (steeringWheelNode != null && steeringWheelNode.name != null && steeringWheelNode.name !== "") {
                this.steeringWheelHub = this.getChildNode(steeringWheelNode.name, TOOLKIT.SearchType.IndexOf, false);
            ...
            if (angularDampener != null)
                this.m_angularDampener = TOOLKIT.Utilities.ParseVector3(angularDampener);
            const smokeTextureInfo = this.getProperty("smokeTexture");
            if (smokeTextureInfo != null) {
                this.smokeTexture = TOOLKIT.Utilities.ParseTexture(smokeTextureInfo, this.scene);
            }
            ...
            if (this.engineTorqueCurve == null)
                TOOLKIT.SceneManager.LogWarning("Failed to parse engine torque curve for: " + this.transform.name);
        }
        initVehicleState() {
            TOOLKIT.Utilities.ValidateTransformQuaternion(this.transform);
            // Register Vehicle
            ...
            this._rigidbody = this.getComponent("TOOLKIT.RigidbodyPhysics");
                    ...
                    if (this.raycastVehicle.getNumWheels() >= 4) {
                        if (this.BACK_LEFT >= 0 && backLeftWheelName != null) {
                            ...
                            if (this.backLeftWheelMesh != null) {
                                ...
                                this.m_backLeftWheel.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.backLeftWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
                                this.backLeftWheelEmitter = new BABYLON.Mesh("Emitter_RL");
                        ...
                        if (this.BACK_RIGHT >= 0 && backRightWheelName != null) {
                            ...
                            if (this.backRightWheelMesh != null) {
                                ...
                                this.m_backRightWheel.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.backRightWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
                                this.backRightWheelEmitter = new BABYLON.Mesh("Emitter_RR");
                        ...
                        if (this.FRONT_LEFT >= 0 && frontLeftWheelName != null) {
                            ...
                            if (this.frontLeftWheelMesh != null) {
                                ...
                                this.m_frontLeftWheel.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.frontLeftWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
                                this.frontLeftWheelEmitter = new BABYLON.Mesh("Emitter_FL");
                        ...
                        if (this.FRONT_RIGHT >= 0 && frontRightWheelName != null) {
                            ...
                            if (this.frontRightWheelMesh != null) {
                                ...
                                this.m_frontRightWheel.spinner = TOOLKIT.SceneManager.FindChildTransformNode(this.frontRightWheelMesh, "Wheel", TOOLKIT.SearchType.IndexOf, true);
                                this.frontRightWheelEmitter = new BABYLON.Mesh("Emitter_FR");
                        ...
                        // ..
                        // this.raycastVehicle.setCollisionFilterGroup(TOOLKIT.CollisionFilters.DefaultFilter);
                        // this.raycastVehicle.setCollisionFilterMask(TOOLKIT.CollisionFilters.StaticFilter);
                        // ..
                        // Setup Skid Audio Sources
                        // ..
                        if (this._skidAudioSource == null && this.backRightWheelMesh != null)
                        ...
                        TOOLKIT.SceneManager.LogWarning("Invalid vehicle controller wheel count info for: " + this.transform.name);
                    }
                }
                else {
                    TOOLKIT.SceneManager.LogWarning("No wheel collider information found for: " + this.transform.name);
                }
            }
            else {
                TOOLKIT.SceneManager.LogWarning("Failed to get rigidbody component: " + this.transform.name);
            }
        }
        updateVehicleState() {
            this.m_linearVelocity = this.transform.absolutePosition.subtract(this.m_lastPosition);
        ...
        currentSkidding = false;
        currentDonuts = false;
        currentSlipAngle = 0;
        currentDrivePower = 0;
        targetDrivePower = 0;
        animatorSteerAngle = 0;
        ...
        drive(throttle, steering, braking, donuts, booster = 0, autopilot = false, nos = false) {
            ...
            TOOLKIT.WindowManager.PrintToScreen("MPH: " + this.americanSpeed.toFixed(0) + " --> RPM: " + this.engineRPM.toFixed(0) + " --> Gear: " + this.gearIndex.toFixed(0) + " --> Power: " + this.currentDrivePower.toFixed(2) + " --> Boost Time: " + this.boostSpeedTimer.toFixed(2) + " --> Donut Meter: " + this.donutMeter.toFixed(2) + " --> Burnout Meter: " + this.burnoutMeter.toFixed(2));
            // ..
                ...
                if (this.handBraking === true) {
                    ...
                    if (this.forwardSpeed >= 0 && this.handBrakingTimer < this.skidRotationTimeout) {
                        ...
                        if (extraSkidRotation !== 0) {
                            ...
                            //TOOLKIT.WindowManager.PrintToScreen("Extra Skid Rotation: " + this._skidExtraRotation.y.toFixed(2), "green");
                        }
                    }
                    // ..
                    ...
                    if (this.forwardSpeed >= 0 && this.wheelBurnout === true && this.wheelDonuts === true) {
                        ...
                        if (extraDonutRotation !== 0) {
                            ...
                            //TOOLKIT.WindowManager.PrintToScreen("Extra Donut Rotation: " + this._donutExtraRotation.y.toFixed(2), "red");
                        }
                    }
                    // ..
        ...
        syncVehicleState(deltaTime) {
            ...
            if (this._rigidbody != null && this.raycastVehicle != null) {
                ...
                // ..
                this.americanSpeed = (this.absoluteSpeed * TOOLKIT.System.Kph2Mph);
                ...
                if (this.gearBoxShiftRatios != null && this.gearIndex >= 0 && this.gearIndex < gearCount) {
                    ...
                    const wheelDiameter = (this.wheelRadius * 2 * TOOLKIT.System.Meter2Inch);
                    ...
                    */
                    ...
                    if (this.americanSpeed < 5) {
                        this.gearIndex = 0;
                        this.shiftingSide = TOOLKIT.Utilities.GetRandomRange(-10, 10) > 0 ? 1 : -1;
                    }
                    else {
            ...
            if (this.playVehicleSounds === true) {
                if (this._engineAudioSource != null) {
                    this._engineAudioSource.setPitch(this.enginePitchLevel);
                }
            }
            ...
            if (this.playVehicleSounds === true) {
                if (this._nosAudioSource != null) {
                    this._nosAudioSource.setPitch(this.POWER_BOOST_PITCH);
                }
            }
            // Update Smoke Instensity
            this.smokeDonuts = BABYLON.Scalar.Clamp(this.smokeDonuts, 1, 10);
            ...
            */
            ...
            if (this.postNetworkAttributes == true && TOOLKIT.EntityController.HasNetworkEntity(this.transform)) {
                ...
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 0, pitch_Attribute); // Pitch
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 1, brake_Attribute); // Brake
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 2, reverse_Attribute); // Reverse
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 3, burnout_Attribute); // Burnout
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 4, SKID_FL_Attribute); // SKID_FL
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 5, SKID_FR_Attribute); // SKID_FR
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 6, SKID_RL_Attribute); // SKID_RL
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 7, SKID_RR_Attribute); // SKID_RR
                if (SPIN_FL_Transform != null && SPIN_FL_Transform.rotationQuaternion != null) {
                    SPIN_FL_Transform.rotationQuaternion.toEulerAnglesToRef(this.SPIN_FL_Rotation);
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 8, this.SPIN_FL_Rotation.x); // SPIN_FL
                }
                else {
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 8, 0);
                }
                if (SPIN_FR_Transform != null && SPIN_FR_Transform.rotationQuaternion != null) {
                    SPIN_FR_Transform.rotationQuaternion.toEulerAnglesToRef(this.SPIN_FR_Rotation);
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 9, this.SPIN_FR_Rotation.x); // SPIN_FR
                }
                else {
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 9, 0);
                }
                if (SPIN_RL_Transform != null && SPIN_RL_Transform.rotationQuaternion != null) {
                    SPIN_RL_Transform.rotationQuaternion.toEulerAnglesToRef(this.SPIN_RL_Rotation);
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 10, this.SPIN_RL_Rotation.x); // SPIN_RL
                }
                else {
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 10, 0);
                }
                if (SPIN_RR_Transform != null && SPIN_RR_Transform.rotationQuaternion != null) {
                    SPIN_RR_Transform.rotationQuaternion.toEulerAnglesToRef(this.SPIN_RR_Rotation);
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 11, this.SPIN_RR_Rotation.x); // SPIN_RR
                }
                else {
                    TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 11, 0);
                }
                TOOLKIT.EntityController.PostBufferedAttribute(this.transform, 12, this.animatorSteerAngle); // Steering
            }
            ///////////////////////////////////////////
        ...
        currentPitch = 0; // Current pitch angle for forward-backward tilt
        currentRoll = 0; // Current roll angle for side-to-side tilt
        previousSpeed = 0; // Previous frame speed for comparison
        angularVelocity = new BABYLON.Vector3(0, 0, 0); // Current angular velocity of the vehicle
        syncVehicleTilting(deltaTime) {
            ...
            if (this.movementTilting === true) {
                ...
                // TOOLKIT.WindowManager.PrintToScreen("CHECK - Pitch: " + this.currentPitch.toFixed(2) + " Roll: " + this.currentRoll.toFixed(2) + " Speed Change: " + speedChange.toFixed(2), "white");
                if (this.chassisTransform != null && this.chassisTransform.rotationQuaternion != null) {
                    ...
                    // TOOLKIT.WindowManager.PrintToScreen("Sync Pitch: " + tiltAngleX.toFixed(2) + " Roll: " + tiltAngleZ.toFixed(2) + " Speed Change: " + speedChange.toFixed(2), "white");
        ...
        getVehicleEngineTorque(rpm, power) {
            let result = 0;
            if (this.engineTorqueCurve != null) {
                result = (TOOLKIT.Utilities.SampleAnimationFloat(this.engineTorqueCurve, BABYLON.Scalar.Clamp(rpm, this.MIN_RPM, this.MAX_RPM), BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE, false) * power);
            }
            return result;
        }
        createSmokeParticleSystem(name, emitter) {
            const result = new BABYLON.ParticleSystem(name, 10000, this.scene);
            result.blendMode = BABYLON.ParticleSystem.BLENDMODE_STANDARD;
            result.renderingGroupId = TOOLKIT.Utilities.DefaultRenderGroup();
            result.particleTexture = this.smokeTexture;
            result.emitter = emitter;
            result.emitRate = 0;
            result.updateSpeed = 0.01;
        ...
        rearLeftSensorLine = null;
        rearRightSensorLine = null;
        frontLeftFrictionLerping = false;
        frontRightFrictionLerping = false;
        rearLeftFrictionLerping = false;
        rearRightFrictionLerping = false;
        frontLeftFrictionPenalty = false;
        frontRightFrictionPenalty = false;
        rearLeftFrictionPenalty = false;
        rearRightFrictionPenalty = false;
        startRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        endRaycastPosition = new BABYLON.Vector3(0, 0, 0);
        downDirection = new BABYLON.Vector3(0, -1, 0);
        downDistance = 2.0;
        ...
        getRearLeftWheelContactNormal() { return this.rearLeftContactNormal; }
        getRearRightWheelContactNormal() { return this.rearRightContactNormal; }
        wheelContactRaycastResult = new BABYLON.PhysicsRaycastResult();
        castWheelContactRays() {
            ...
            // Front Left Physics Raycast
            // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycast(this.scene, this.startRaycastPosition, this.downDirection, this.downDistance);
            TOOLKIT.RigidbodyPhysics.RaycastToRef(this.startRaycastPosition, this.endRaycastPosition, raycast);
            if (raycast != null && raycast.hasHit === true && raycast.body != null && raycast.body.transformNode != null) {
                this.frontLeftContact = true;
                this.frontLeftContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.body.transformNode);
                this.frontLeftContactPoint.copyFrom(raycast.hitPoint);
                this.frontLeftContactNormal.copyFrom(raycast.hitNormal);
            }
            // Front Left Draw Debug Lines
            ...
            if (raycast != null && raycast.hasHit === true && raycast.body != null && raycast.body.transformNode != null) {
                this.frontRightContact = true;
                this.frontRightContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.body.transformNode);
                this.frontRightContactPoint.copyFrom(raycast.hitPoint);
                this.frontRightContactNormal.copyFrom(raycast.hitNormal);
            }
            // Front Right Draw Debug Lines
            ...
            if (raycast != null && raycast.hasHit === true && raycast.body != null && raycast.body.transformNode != null) {
                this.rearLeftContact = true;
                this.rearLeftContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.body.transformNode);
                this.rearLeftContactPoint.copyFrom(raycast.hitPoint);
                this.rearLeftContactNormal.copyFrom(raycast.hitNormal);
            }
            // Rear Left Draw Debug Lines
            ...
            if (raycast != null && raycast.hasHit === true && raycast.body != null && raycast.body.transformNode != null) {
                this.rearRightContact = true;
                this.rearRightContactTag = TOOLKIT.SceneManager.GetTransformTag(raycast.body.transformNode);
                this.rearRightContactPoint.copyFrom(raycast.hitPoint);
                this.rearRightContactNormal.copyFrom(raycast.hitNormal);
            }
            // Rear Right Draw Debug Lines
...
(function (PROJECT) {
    ...
    */
    class VehicleCameraManager extends TOOLKIT.ScriptComponent {
        ...
        buttonCamera = BABYLON.Xbox360Button.Y;
        keyboardCamera = TOOLKIT.UserInputKey.P;
        tickRemoteEntities = false;
        fastMotionBlur = false;
        lowSpeedBlurring = 0.0;
        highSpeedBlurring = 20.0;
        motionBlurSamples = 32;
        isObjectBasedBlur = true;
        fastCameraShake = false;
        lowSpeedShaking = 1.0;
        highSpeedShaking = 1.0;
        firstPerson = false;
        cameraPivot = null;
        targetEulers = BABYLON.Vector3.Zero();
        cameraRotation = BABYLON.Quaternion.Zero();
        cameraPivotOffset = BABYLON.Vector3.Zero();
        autoAttachCamera = false;
        ...
        m_firstPersonOffset = new BABYLON.Vector3(0.0, 1.15, 0.15);
        ...
        awakeCameraManager() {
            ...
            if (firstPersonOffset != null)
                this.m_firstPersonOffset = TOOLKIT.Utilities.ParseVector3(firstPersonOffset);
        ...
        initCameraManager() {
            ...
            if (this.m_inputController != null) {
                TOOLKIT.InputController.OnKeyboardPress(this.keyboardCamera, () => {
                    //if (this.playerNumber === TOOLKIT.PlayerNumber.One) {
                    this.togglePlayerCamera();
                    //}
                });
                TOOLKIT.InputController.OnGamepadButtonPress(this.buttonCamera, () => {
                    this.togglePlayerCamera();
                } /*, this.playerNumber*/);
            }
        }
            ...
            if (this.enableCamera === true && this.m_cameraTransform != null && this.m_standardController != null) {
                if (this.followTarget === true) {
                    if (this.cameraPivot != null) {
                        ...
                        // Update Position
                        // ..
                        TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.cameraPivot.position);
                        // ..
                        // Update Rotation
                        // ..
                        ...
                        TOOLKIT.Utilities.FromEulerToRef(0, 0, 0, this.m_cameraTransform.rotationQuaternion);
                    }
                }
                else {
            ...
            if (this.enableCamera === true && this.m_cameraTransform != null && this.m_standardController != null) {
                if (this.followTarget === true) {
                    if (this.cameraPivot != null) {
                        const deltaTime = this.getDeltaSeconds();
                        // KEEP FOR REFERECNE
                        // DEPRECIATED: const deltaFactor:number = TOOLKIT.System.SmoothDeltaFactor;
...
(function (PROJECT) {
    class VehicleInputController extends TOOLKIT.ScriptComponent {
        ...
        ackermanRadius = 0.85;
        recoveryRadius = 0.25;
        waypointPosition = BABYLON.Vector3.Zero();
        waypointCount = 0;
        waypointIndex = 0;
        noMovementTime = 0;
        reverseFixMode = false;
        recoveryFixMode = false;
        nextTargetSpeed = 0;
        prevTargetSpeed = 0;
        vehicleResetCheck = 0;
        randomSkillFactor = 0;
        showChaseRabbit = false;
        showSensorLines = false;
        steeringWheelMode = -1;
        rabbitTrackerLine = null;
        rabbitTrackerColor = new BABYLON.Color3(1, 1, 1);
        greenTrackingColor = new BABYLON.Color3(0, 1, 0);
        redTrackingColor = new BABYLON.Color3(1, 0, 0);
        localTargetPosition = new BABYLON.Vector3(0, 0, 0);
        avoidPositionOffset = new BABYLON.Vector3(0, 0, 0);
        avoidanceLerp = 0;
        avoidanceTimer = 0;
        avoidanceValue = 0;
        randomTurning = 0;
        ...
        randomDistance = 0;
        lastCheckpoint = -1;
        mainCenterSensorLine = null;
        mainRightSensorLine = null;
        mainLeftSensorLine = null;
        angleRightSensorLine = null;
        angleLeftSensorLine = null;
        sideRightSensorLine = null;
        sideLeftSensorLine = null;
        backRightSensorLine = null;
        backLeftSensorLine = null;
        sidewaysOffsetVector = BABYLON.Vector3.Zero();
        backBumperEdgeVector = BABYLON.Vector3.Zero();
        sensorStartPos = BABYLON.Vector3.Zero();
        sensorPointPos = BABYLON.Vector3.Zero();
        sensorAnglePos = BABYLON.Vector3.Zero();
        rsideStartPos = BABYLON.Vector3.Zero();
        rsidePointPos = BABYLON.Vector3.Zero();
        lsideStartPos = BABYLON.Vector3.Zero();
        lsidePointPos = BABYLON.Vector3.Zero();
        tempScaleVector = BABYLON.Vector3.Zero();
        rbackStartPos = BABYLON.Vector3.Zero();
        rbackPointPos = BABYLON.Vector3.Zero();
        lbackStartPos = BABYLON.Vector3.Zero();
        lbackPointPos = BABYLON.Vector3.Zero();
        trackVehiclePosition = BABYLON.Vector3.Zero();
        trackRabbitPosition = BABYLON.Vector3.Zero();
        // Public Properties
        ...
        resetTiming = 3.0;
        playerNumber = TOOLKIT.PlayerNumber.One;
        pedelForward = 7; // Generic Button 7 (Foot Pedal)
        triggerForward = TOOLKIT.Xbox360Trigger.Right;
        keyboardForawrd = TOOLKIT.UserInputKey.W;
        auxKeyboardForawrd = TOOLKIT.UserInputKey.UpArrow;
        pedalBackward = 6; // Generic Button 6 (Foot Pedal)
        triggerBackwards = TOOLKIT.Xbox360Trigger.Left;
        keyboardBackwards = TOOLKIT.UserInputKey.S;
        auxKeyboardBackwards = TOOLKIT.UserInputKey.DownArrow;
        pedalBooster = 1; // Generic Button 1 (Speed Booster)
        keyboardBooster = TOOLKIT.UserInputKey.Ctrl;
        buttonBooster = BABYLON.Xbox360Button.B;
        buttonHandbrake = BABYLON.Xbox360Button.X;
        keyboardHandbrake = TOOLKIT.UserInputKey.SpaceBar;
        leftWheelHandbrake = 4; // Generic Button 4 (Hand Paddle)
        rightWheelHandbrake = 5; // Generic Button 5 (Hand Paddle)
        keyboardDonut = TOOLKIT.UserInputKey.Shift;
        leftButtonDonut = BABYLON.Xbox360Button.LB;
        rightButtonDonut = BABYLON.Xbox360Button.RB;
        leftWheelDonut = 10; // Generic Button 10 (Wheel Button)
        rightWheelDonut = 11; // Generic Button 11 (Wheel Button)
        // Auto Pilot Properties
        raceLineNode = 0;
        minLookAhead = 5;
        maxLookAhead = 50;
        driverSkillLevel = 1;
        chaseRabbitSpeed = 1.0;
        throttleSensitivity = 1;
        steeringSensitivity = 1;
        brakingSensitivity = 1;
        brakingTurnAngle = 15;
        brakingSpeedLimit = 90;
        skiddingSpeedLimit = 100;
        linearDampenForce = 0.1;
        driveSpeedMultiplier = 5.0;
        driveLineDistance = 1.0;
        resetMovingTimeout = 3;
        reverseThrottleTime = 3;
        maxRaceTrackSpeed = 0;
        trackManagerIdentity = "TrackManager";
        ...
        m_chasePointMesh = null;
        m_chaseRabbitMesh = null;
        m_circuitInterfaces = null;
        m_circuitRaceLine_1 = null;
        m_circuitRaceLine_2 = null;
        m_circuitRaceLine_3 = null;
        m_circuitRaceLine_4 = null;
        m_circuitRaceLine_5 = null;
        m_rigidbodyPhysics = null;
        m_checkpointManager = null;
        m_standardCarController = null;
        ...
        awakeVehicleController() {
            ...
            TOOLKIT.WindowManager.SetInterval(randomizer, () => { this.randomSkillFactor = this.getRandomNumber(1, 20); });
        }
        initVehicleController() {
            this.m_rigidbodyPhysics = this.getComponent("TOOLKIT.RigidbodyPhysics");
            ...
            if (this.m_rigidbodyPhysics != null) {
                this.m_rigidbodyPhysics.onCollisionEnterObservable.add((mesh) => {
                    const tag = TOOLKIT.SceneManager.GetTransformTag(mesh);
                    if (tag === this.vehicleTag) {
                        // TOOLKIT.SceneManager.ConsoleWarn(this.transform.name.toLocaleUpperCase() + " CAR COLLISION ENTER: " + mesh.name + " ---> TAG: " + tag);
                    }
                });
                this.m_rigidbodyPhysics.onCollisionStayObservable.add((mesh) => {
                    if (mesh != null) {
                        const tag = TOOLKIT.SceneManager.GetTransformTag(mesh);
                        if (tag === this.vehicleTag) {
                            // TOOLKIT.SceneManager.ConsoleLog(this.transform.name.toLocaleUpperCase() + " CAR COLLISION STAY: " + mesh.name + " ---> TAG: " + tag);
                        }
                    }
                });
                this.m_rigidbodyPhysics.onCollisionExitObservable.add((mesh) => {
                    if (mesh != null) {
                        const tag = TOOLKIT.SceneManager.GetTransformTag(mesh);
                        if (tag === this.vehicleTag) {
                            // TOOLKIT.SceneManager.ConsoleWarn(this.transform.name.toLocaleUpperCase() + " CAR COLLISION EXIT: " + mesh.name + " ---> TAG: " + tag);
                        }
                    }
                });
            }
            else {
                TOOLKIT.SceneManager.LogWarning("Null rigidbody physics for: " + this.transform.name);
            }
            ...
            //} else {
            //    TOOLKIT.SceneManager.LogWarning("Null standard car controller for: " + this.transform.name);
            //}
            // Get Race Track Manager Waypoints
            const waypointsTransform = TOOLKIT.SceneManager.GetTransformNode(this.scene, this.trackManagerIdentity);
            if (waypointsTransform != null) {
                const raceTrackManager = TOOLKIT.SceneManager.FindScriptComponent(waypointsTransform, "PROJECT.RaceTrackManager");
                if (raceTrackManager != null) {
                    ...
                    TOOLKIT.SceneManager.LogWarning("Fail to locate race track manager for: " + this.transform.name);
                }
            }
            else {
                TOOLKIT.SceneManager.LogWarning("Fail to locate race track manager '" + this.trackManagerIdentity + "' for: " + this.transform.name);
            }
        }
        updateVehicleController() {
            ...
            if (this.resetTiming > 0 && this.m_standardCarController != null) {
                const gameTime = TOOLKIT.SceneManager.GetGameTime();
                ...
                if (gameTime > (this.vehicleResetCheck + this.resetTiming)) {
                    ...
                    TOOLKIT.Utilities.LookRotationToRef(this.transform.forward, this.transform.rotationQuaternion);
                }
            }
        }
        updateManualInputDrive() {
            if (this.m_standardCarController != null) {
                this.playerDeltaX = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.Horizontal, this.playerNumber);
                this.playerDeltaY = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.Vertical, this.playerNumber);
                this.playerMouseX = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.MouseX, this.playerNumber);
                this.playerMouseY = TOOLKIT.InputController.GetUserInput(TOOLKIT.UserInputAxis.MouseY, this.playerNumber);
                // Get Button Triggers
                const auxForwardKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.auxKeyboardForawrd); // Player One Only
                const forwardKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.keyboardForawrd); // Player One Only
                const forwardTrigger = TOOLKIT.InputController.GetGamepadTriggerInput(this.triggerForward, this.playerNumber);
                const forwardPedal = TOOLKIT.InputController.GetGamepadButtonInput(this.pedelForward, this.playerNumber);
                const auxBackwardKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.auxKeyboardBackwards); // Player One Only
                const backwardKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.keyboardBackwards); // Player One Only
                const backwardTrigger = TOOLKIT.InputController.GetGamepadTriggerInput(this.triggerBackwards, this.playerNumber);
                const backwardPedal = TOOLKIT.InputController.GetGamepadButtonInput(this.pedalBackward, this.playerNumber);
                const boosterPedal = TOOLKIT.InputController.GetGamepadButtonInput(this.pedalBooster, this.playerNumber);
                const boosterKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.keyboardBooster); // Player One Only
                const boosterButton = TOOLKIT.InputController.GetGamepadButtonInput(this.buttonBooster, this.playerNumber);
                const handbrakeKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.keyboardHandbrake); // Player One Only
                const handbrakeButton = TOOLKIT.InputController.GetGamepadButtonInput(this.buttonHandbrake, this.playerNumber);
                const handbrakeWheel_L = TOOLKIT.InputController.GetGamepadButtonInput(this.leftWheelHandbrake, this.playerNumber);
                const handbrakeWheel_R = TOOLKIT.InputController.GetGamepadButtonInput(this.rightWheelHandbrake, this.playerNumber);
                const donutKeyboard = TOOLKIT.InputController.GetKeyboardInput(this.keyboardDonut); // Player One Only
                const donutButton_L = TOOLKIT.InputController.GetGamepadButtonInput(this.leftButtonDonut, this.playerNumber);
                const donutButton_R = TOOLKIT.InputController.GetGamepadButtonInput(this.rightButtonDonut, this.playerNumber);
                const donutWheel_L = TOOLKIT.InputController.GetGamepadButtonInput(this.leftWheelDonut, this.playerNumber);
                const donutWheel_R = TOOLKIT.InputController.GetGamepadButtonInput(this.rightWheelDonut, this.playerNumber);
                ...
                else if (this.playerNumber === TOOLKIT.PlayerNumber.One && (forwardKeyboard === true || auxForwardKeyboard === true))
                    playerMovement = 1;
                else if (TOOLKIT.InputController.AllowMobileControls === true && TOOLKIT.InputController.MobileControlsActive === true && this.playerDeltaY > 0)
                ...
                else if (this.playerNumber === TOOLKIT.PlayerNumber.One && (backwardKeyboard === true || auxBackwardKeyboard === true))
                    playerMovement = -1;
                else if (TOOLKIT.InputController.AllowMobileControls === true && TOOLKIT.InputController.MobileControlsActive === true && this.playerDeltaY < 0)
                    playerMovement = this.playerDeltaY; // Mobile Controls
                ...
                if (this.steeringWheelMode === -1 && TOOLKIT.UserInputOptions.SupportedInputDevices != null && TOOLKIT.UserInputOptions.SupportedInputDevices.length > 0) {
                    const gamepad = TOOLKIT.InputController.GetGamepad(this.playerNumber);
                    if (gamepad != null && gamepad.id != null) {
                        let foundSupportedDevice = false;
                        for (let index = 0; index < TOOLKIT.UserInputOptions.SupportedInputDevices.length; index++) {
                            const wheel = TOOLKIT.UserInputOptions.SupportedInputDevices[index];
        ...
        autoDriveRaycastResult = new BABYLON.PhysicsRaycastResult();
        updateAutoPilotDrive() {
            if (this.m_standardCarController != null) {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.rsideStartPos, this.sidewaysOffsetVector);
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.rbackStartPos, this.backBumperEdgeVector);
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.lsideStartPos, this.sidewaysOffsetVector);
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                TOOLKIT.Utilities.GetAbsolutePositionToRef(this.transform, this.lbackStartPos, this.backBumperEdgeVector);
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, this.sensorStartPos, this.sensorPointPos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(this.sensorStartPos, this.sensorPointPos, raycast);
                if (raycast.hasHit === true && raycast.body != null && raycast.body.transformNode != null) {
                    tagname = TOOLKIT.SceneManager.GetTransformTag(raycast.body.transformNode);
                ...
                if (this.showSensorLines === true) {
                    if (this.mainRightSensorLine == null)
                        this.mainRightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".MainRightSensorLine", this.scene);
                    if (contact === true) {
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, this.sensorStartPos, this.sensorAnglePos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(this.sensorStartPos, this.sensorAnglePos, raycast);
                ...
                if (this.showSensorLines === true) {
                    if (this.angleRightSensorLine == null)
                        this.angleRightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".AngleRightSensorLine", this.scene);
                    if (contact === true) {
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, this.rsideStartPos, this.rsidePointPos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(this.rsideStartPos, this.rsidePointPos, raycast);
                ...
                if (this.showSensorLines === true) {
                    if (this.sideRightSensorLine == null)
                        this.sideRightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".SideRightSensorLine", this.scene);
                    if (contact === true) {
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, this.rbackStartPos, this.rbackPointPos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(this.rbackStartPos, this.rbackPointPos, raycast);
                ...
                if (this.showSensorLines === true) {
                    if (this.backRightSensorLine == null)
                        this.backRightSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".BackRightSensorLine", this.scene);
                    if (contact === true) {
                ...
                if (this.showSensorLines === true) {
                    if (this.mainLeftSensorLine == null)
                        this.mainLeftSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".MainLeftSensorLine", this.scene);
                    if (contact === true) {
                ...
                if (this.showSensorLines === true) {
                    if (this.angleLeftSensorLine == null)
                        this.angleLeftSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".AngleLeftSensorLine", this.scene);
                    if (contact === true) {
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, this.lsideStartPos, this.lsidePointPos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(this.lsideStartPos, this.lsidePointPos, raycast);
                ...
                if (this.showSensorLines === true) {
                    if (this.sideLeftSensorLine == null)
                        this.sideLeftSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".SideLeftSensorLine", this.scene);
                    if (contact === true) {
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, this.lbackStartPos, this.lbackPointPos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(this.lbackStartPos, this.lbackPointPos, raycast);
                ...
                if (this.showSensorLines === true) {
                    if (this.backLeftSensorLine == null)
                        this.backLeftSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".BackLeftSensorLine", this.scene);
                    if (contact === true) {
                ...
                contact = false;
                raycast.reset();
                // FIXME: raycast = TOOLKIT.RigidbodyPhysics.PhysicsRaycastToPoint(this.scene, firstSensorStartPos, firstSensorPointPos);
                TOOLKIT.RigidbodyPhysics.RaycastToRef(firstSensorStartPos, firstSensorPointPos, raycast);
                if (avoidance === 0) {
                    if (raycast.hasHit === true && raycast.body != null && raycast.body.transformNode != null) {
                        tagname = TOOLKIT.SceneManager.GetTransformTag(raycast.body.transformNode);
                        contact = (tagname == this.vehicleTag || tagname === this.obstacleTag);
                ...
                if (this.showSensorLines === true) {
                    if (this.mainCenterSensorLine == null)
                        this.mainCenterSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".MainCenterSensorLine", this.scene);
                    if (contact === true) {
                ...
                tagname = "";
                contact = false;
                raycast = TOOLKIT.SceneManager.PhysicsRaycastToPoint(this.scene, firstSensorStartPos, firstSensorPointPos);
                if (avoidance === 0) {
                    if (raycast.hasHit === true && raycast.collisionObject != null && raycast.collisionObject.entity != null) {
                        tagname = TOOLKIT.SceneManager.GetTransformTag(raycast.collisionObject.entity);
                        contact = (tagname == this.vehicleTag || tagname === this.obstacleTag);
                        if (contact === true) {
                        }
                    }
                ...
                if (this.showSensorLines === true) {
                    if (this.mainCenterSensorLine == null) this.mainCenterSensorLine = new TOOLKIT.LinesMeshRenderer(this.transform.name + ".MainCenterSensorLine", this.scene);
                    if (contact === true) {
                        this.mainCenterSensorLine.drawLine([firstSensorStartPos, raycast.hitPoint], BABYLON.Color3.Yellow());
                    } else {
                        this.mainCenterSensorLine.drawLine([firstSensorStartPos, firstSensorPointPos], BABYLON.Color3.Blue());
                ...
                */
                ...
                if (this.m_chaseRabbitMesh != null && this.waypointCount > 0 && trackNode != null && controlPoint != null) {
                    ...
                    TOOLKIT.Utilities.LookRotationToRef(aheadPoint.direction, this.m_chasePointMesh.rotationQuaternion);
                    // ..
                    ...
                    TOOLKIT.Utilities.PrintToScreen("Waypoint: " + this.waypointIndex + " --> Delta Length: " + deltaLength.toFixed(2) + " --> Progress Distance: " + this.progressDistance);
                    */
                    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    // TODO - UPDATE CHASE RABBIT - Walk Spline Waypoint Positions - (RaceTrackManager.GetRoadAheadDirection) - ???
                    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    TOOLKIT.Utilities.GetAbsolutePositionToRef(this.m_chaseRabbitMesh, this.m_chasePointMesh.position, this.avoidPositionOffset);
                    if (this.showChaseRabbit === true) {
                        ...
                        if (this.rabbitTrackerLine == null)
                            this.rabbitTrackerLine = new TOOLKIT.LinesMeshRenderer((this.transform.name + ".TrackingLine"), this.scene);
                        if (this.rabbitTrackerLine != null)
                    ...
                    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    // DEPRECIATED: TOOLKIT.Utilities.InverseTransformPointToRef(this.transform, rabbitPosition, this.localTargetPosition);
                    TOOLKIT.Utilities.InverseTransformPointToRef(this.transform, this.m_chasePointMesh.position, this.localTargetPosition);
                    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    if (this.noMovementTime >= this.resetMovingTimeout) {
                        ...
                        TOOLKIT.WindowManager.SetTimeout(reverseTime, () => { this.reverseFixMode = false; });
                        TOOLKIT.WindowManager.SetTimeout(recoveryTime, () => { this.recoveryFixMode = false; });
                    }
        ...
        getDriverSkillFactor() {
            ...
            // TOOLKIT.WindowManager.PrintToScreen("Driver Skill Level: " + skill);
            switch (skill) {
                case 10:
                    result = 1.00;
                    break;
...
(function (PROJECT) {
    ...
    */
    class VehicleNetworkLabel extends TOOLKIT.ScriptComponent {
        ...
        offsetX = 0;
        offsetY = 0;
        labelColor = new BABYLON.Color3(1.0, 1.0, 1.0);
        borderColor = new BABYLON.Color3(0.0, 0.8431373, 0.827451);
        backgroundColor = new BABYLON.Color3(0.0, 0.4745098, 0.4666667);
        labelCreated = false;
        update() {
            if (this.labelCreated === false && this.autoCreate === true && this.isReady()) {
                if (BABYLON.NetworkManager.HasJoinedRoom()) {
                    const ownerName = TOOLKIT.EntityController.QueryNetworkAttribute(this.transform, "ownerName");
                    if (ownerName != null && ownerName !== "") {
                        this.autoCreate = false;
        ...
        createLabel(name) {
            const advancedTexture = PROJECT.VehicleNetworkLabel.GetFullscreenUI(this.scene);
        ...
        static AdvDynamicTexture = null;
        /** Get the default fullscreen user interface advanced dynamic texture */
        static GetFullscreenUI(scene, sampling = BABYLON.Texture.BILINEAR_SAMPLINGMODE) {
            if (PROJECT.VehicleNetworkLabel.AdvDynamicTexture == null) {
                PROJECT.VehicleNetworkLabel.AdvDynamicTexture = BABYLON.GUI.AdvancedDynamicTexture.CreateFullscreenUI("Default-Screen-UI", true, scene, sampling);
            }
            return PROJECT.VehicleNetworkLabel.AdvDynamicTexture;
        }
    }
    ...
    class FxParticleSystem extends TOOLKIT.ScriptComponent {
        ...
        awake() {
            ...
            if (this.m_particleEmitter == null) {
                ...
                this.m_particleEmitter.material = TOOLKIT.Utilities.GetColliderMaterial(this.scene);
            }
...
(function (PROJECT) {
    ...
    class SkyMaterialSystem extends TOOLKIT.ScriptComponent {
        ...
        reflections = false;
        reflectlevel = 1;
        skytintcolor = new BABYLON.Color3(1, 1, 1);
        ...
        awakeSkyboxMaterial() {
            ...
            if (tintColor != null)
                this.skytintcolor = TOOLKIT.Utilities.ParseColor3(tintColor);
            // ..
            ...
            */
            ...
            if (camOffsetData != null)
                this.m_skyMaterial.cameraOffset = TOOLKIT.Utilities.ParseVector3(camOffsetData);
            /**
            ...
            if (this.scene.metadata != null && this.scene.metadata.unity != null && this.scene.metadata.unity) {
                if (this.scene.metadata.toolkit.sunposition != null) {
                    this.m_skyMaterial.sunPosition = TOOLKIT.Utilities.ParseVector3(this.scene.metadata.toolkit.sunposition);
                }
            }
...
(function (PROJECT) {
    ...
    class WaterMaterialSystem extends TOOLKIT.ScriptComponent {
        waterTag = "Water";
        targetSize = new BABYLON.Vector2(128, 128);
        renderSize = new BABYLON.Vector2(512, 512);
        depthFactor = 1.0;
        reflectSkybox = true;
        subDivisions = 32;
        heightOffset = 1.0;
        windDirection = new BABYLON.Vector2(0, 1);
        windForce = 6;
        waveSpeed = 1.0;
        waveLength = 0.4;
        waveHeight = 0.4;
        ...
        waterColor = new BABYLON.Color3(0.1, 0.1, 0.6);
        colorBlendFactor = 0.2;
        waterColor2 = new BABYLON.Color3(0.1, 0.1, 0.6);
        ...
        awake() {
            ...
            this.waterColor = TOOLKIT.Utilities.ParseColor3(wcolor1);
            // ..
            const wcolor2 = this.getProperty("waterColor2");
            this.waterColor2 = TOOLKIT.Utilities.ParseColor3(wcolor2);
            // ..
            const wdirection = this.getProperty("windDirection");
            this.windDirection = TOOLKIT.Utilities.ParseVector2(wdirection);
            // ..
            const itargetsize = this.getProperty("targetSize");
            if (itargetsize != null)
                this.targetSize = TOOLKIT.Utilities.ParseVector2(itargetsize);
            // ..        
            const irendersize = this.getProperty("renderSize");
            if (irendersize != null)
                this.renderSize = TOOLKIT.Utilities.ParseVector2(irendersize);
            /* Awake component function */
            let bumpTexture = null;
            const bumpTextureData = this.getProperty("bumpTexture");
            if (bumpTextureData != null)
                bumpTexture = TOOLKIT.Utilities.ParseTexture(bumpTextureData, this.scene);
            if (bumpTexture != null) {
                ...
                if (this.reflectSkybox === true) {
                    const skyboxMesh = TOOLKIT.SceneManager.GetDefaultSkybox(this.scene);
                    if (skyboxMesh != null)
                ...
                TOOLKIT.SceneManager.LogWarning("No supported water bump texture for: " + this.transform.name);
            }
        }
        start() { }
        update() { }
...
(function (PROJECT) {
    ...
    */
    class SnapshotManager extends TOOLKIT.ScriptComponent {
        ...
        static IsSnapshotRenderingEnabled() { return PROJECT.SnapshotManager._HelperEnabled; }
        /**
         ...
         */
        static EnableSnapshotRendering() {
            if (PROJECT.SnapshotManager._SnapshotHelper != null) {
                PROJECT.SnapshotManager._SnapshotHelper.enableSnapshotRendering();
                PROJECT.SnapshotManager._HelperEnabled = true;
            }
        }
        /**
         ...
         * Note that this method is ref-counted and works in pair with disableSnapshotRendering(): you should call enableSnapshotRendering() as many times as you call disableSnapshotRendering().
         */
        static DisableSnapshotRendering() {
            if (PROJECT.SnapshotManager._SnapshotHelper != null) {
                PROJECT.SnapshotManager._SnapshotHelper.disableSnapshotRendering();
                PROJECT.SnapshotManager._HelperEnabled = false;
            }
        }
        // /**
        //  * Add a mesh to the list of meshes to render snapshots for.
        //  * @param mesh The mesh to render snapshots for.
        //  */
        // public static AddSnapshotRenderMesh(mesh: BABYLON.AbstractMesh): void {
        //     if (PROJECT.SnapshotManager._SnapshotMeshes == null) {
        //         PROJECT.SnapshotManager._SnapshotMeshes = [];
        //     }
        //     if (PROJECT.SnapshotManager._SnapshotMeshes != null) {
        //         PROJECT.SnapshotManager._SnapshotMeshes.push(mesh);
        //         // DEBUG: console.warn("### Added mesh to snapshot rendering: " + mesh.name);
        //     }
        // }
        // /**
        //  * Remove a mesh from the list of meshes to render snapshots for.
        //  * @param mesh The mesh to remove from the list of meshes to render snapshots for.
        //  */
        // public static RemoveSnapshotRenderMesh(mesh: BABYLON.AbstractMesh): void {
        //     if (PROJECT.SnapshotManager._SnapshotMeshes != null) {
        //         const index = PROJECT.SnapshotManager._SnapshotMeshes.indexOf(mesh);
        //         if (index > -1) {
        //             PROJECT.SnapshotManager._SnapshotMeshes.splice(index, 1);
        //         }
        //     }
        // }
        /**
         ...
         */
        static ResetSnapshotHelper(scene) {
            if (PROJECT.SnapshotManager._SnapshotHelper != null) {
                PROJECT.SnapshotManager._SnapshotHelper.dispose();
                PROJECT.SnapshotManager._SnapshotHelper = null;
            }
            PROJECT.SnapshotManager._SnapshotHelper = new BABYLON.SnapshotRenderingHelper(scene, { morphTargetsNumMaxInfluences: 20 });
            //PROJECT.SnapshotManager._SnapshotMeshes = [];
            PROJECT.SnapshotManager._HelperEnabled = false;
        }
        /**
         ...
         */
        static GetSnapshotHelper() {
            return PROJECT.SnapshotManager._SnapshotHelper;
        }
        static _HelperEnabled = false;
        //private static _SnapshotMeshes: BABYLON.AbstractMesh[] = [];
        static _SnapshotHelper = null;
        autoStart = false;
        autoUpdate = true;
        delayTimeout = 3.0;
        constructor(transform, scene, properties, scriptComponentAlias) {
        ...
        start() {
            console.warn("*** SnapshotManager Started ***");
            if (PROJECT.SnapshotManager._SnapshotHelper != null) {
                PROJECT.SnapshotManager._SnapshotHelper.fixMeshes();
                console.warn("Snapshot Helper Fixed Meshes.");
            }
            this.scene.meshes.forEach(element => {
                console.log("Fixup Mesh: " + element.name + " ->: Always Select Mesh: " + element.alwaysSelectAsActiveMesh, element);
            });
        }
        ready() {
            if (this.autoStart === true) {
                if (this.delayTimeout > 0) {
                    TOOLKIT.WindowManager.SetTimeout((this.delayTimeout * 1000), () => {
                        PROJECT.SnapshotManager.EnableSnapshotRendering();
                    });
                }
                else {
                    PROJECT.SnapshotManager.EnableSnapshotRendering();
        ...
        update() {
            // if (PROJECT.SnapshotManager._SnapshotHelper != null && PROJECT.SnapshotManager._SnapshotMeshes != null && PROJECT.SnapshotManager._HelperEnabled === true) {
            //     PROJECT.SnapshotManager._SnapshotHelper.updateMesh(PROJECT.SnapshotManager._SnapshotMeshes);
            //     // DEBUG: console.warn("Snapshot rendering updated.", PROJECT.SnapshotManager._SnapshotMeshes);
            // }
            if (this.autoUpdate === true) {
                if (PROJECT.SnapshotManager._SnapshotHelper != null && PROJECT.SnapshotManager._HelperEnabled === true) {
                    this.scene.meshes.forEach(mesh => {
                        //console.log("Update Mesh: " + mesh.name, mesh);
        ...
        destroy() {
            PROJECT.SnapshotManager._HelperEnabled = false;
            //PROJECT.SnapshotManager._SnapshotMeshes = null;
            if (PROJECT.SnapshotManager._SnapshotHelper != null) {
                PROJECT.SnapshotManager._SnapshotHelper.dispose();
                PROJECT.SnapshotManager._SnapshotHelper = null;
            }
    ...
    PROJECT.SnapshotManager = SnapshotManager;
})(PROJECT || (PROJECT = {}));
var PROJECT;
(function (PROJECT) {
    /**
    ...
    */
    class SnapshotRenderer extends TOOLKIT.ScriptComponent {
        start() {
            ...
            // const mesh:BABYLON.AbstractMesh = this.getAbstractMesh();
            // if (mesh != null) meshes.push(mesh);
            // const children:BABYLON.AbstractMesh[] = this.transform.getChildMeshes(false);
            // if (children != null) meshes.push(...children);
            // if (meshes != null && meshes.length > 0) {
            //     meshes.forEach((element:BABYLON.AbstractMesh) => {
            //         PROJECT.SnapshotManager.AddSnapshotRenderMesh(element);
            //     });
            // }
        }
    }
    PROJECT.SnapshotRenderer = SnapshotRenderer;
})(PROJECT || (PROJECT = {}));
var PROJECT;
(function (PROJECT) {
    /**
    ...
    */
    class DefaultMuteButton extends TOOLKIT.ScriptComponent {
        ...
        handleButtonClick() {
            ...
            // ..
            // DEPRECIATED: SM.PostWindowMessage({command: 'mute', source: 'babylon', param: this.muteButtonState}, "*");
            // ..
...
(function (BABYLON) {
    ...
    class WindowsPlatform {
        ...
        static IsXboxLiveUserSignedIn(systemUser = null, player = TOOLKIT.PlayerNumber.One) {
            if (TOOLKIT.WindowManager.IsWindows()) {
        ...
        static XboxLiveUserSignIn(player = TOOLKIT.PlayerNumber.One, oncomplete, onerror, onprogress) {
            if (TOOLKIT.WindowManager.IsWindows()) {
        ...
        static XboxLiveUserSilentSignIn(player = TOOLKIT.PlayerNumber.One, oncomplete, onerror, onprogress) {
            return (TOOLKIT.WindowManager.IsWindows()) ? BABYLON.WindowsPlatform.GetXboxLiveUser(player).signInSilentlyAsync(null).then(oncomplete, onerror, onprogress) : null;
        }
        /** Dialog sign in xbox live user if platform services available. (WinRT) */
        static XboxLiveUserDialogSignIn(player = TOOLKIT.PlayerNumber.One, oncomplete, onerror, onprogress) {
            return (TOOLKIT.WindowManager.IsWindows()) ? BABYLON.WindowsPlatform.GetXboxLiveUser(player).signInAsync(null).then(oncomplete, onerror, onprogress) : null;
        }
        /** Loads a xbox live user profile if platform services available. (WinRT) */
        static LoadXboxLiveUserProfile(player = TOOLKIT.PlayerNumber.One, oncomplete, onerror, onprogress) {
            return (TOOLKIT.WindowManager.IsWindows()) ? BABYLON.WindowsPlatform.GetXboxLiveUserContext(player).profileService.getUserProfileAsync(BABYLON.WindowsPlatform.GetXboxLiveUser(player).xboxUserId).then(oncomplete, onerror, onprogress) : null;
        }
        // ************************************** //
        // * Babylon Xbox Live Player Functions * //
        // ************************************** //
        /** Get xbox live user if platform services available. (WinRT) */
        static GetXboxLiveUser(player = TOOLKIT.PlayerNumber.One) {
            let user = null;
            if (TOOLKIT.WindowManager.IsWindows()) {
                switch (player) {
                    case TOOLKIT.PlayerNumber.One:
                        user = window.BabylonToolkit.XboxLive.Plugin.getXboxLiveUserOne();
                        break;
                    case TOOLKIT.PlayerNumber.Two:
                        user = window.BabylonToolkit.XboxLive.Plugin.getXboxLiveUserTwo();
                        break;
                    case TOOLKIT.PlayerNumber.Three:
                        user = window.BabylonToolkit.XboxLive.Plugin.getXboxLiveUserThree();
                        break;
                    case TOOLKIT.PlayerNumber.Four:
        ...
        /** Get xbox live user if platform services available. (WinRT) */
        static GetXboxLiveSystemUser(systemUser, player = TOOLKIT.PlayerNumber.One) {
            let user = null;
            if (TOOLKIT.WindowManager.IsWindows()) {
                switch (player) {
                    case TOOLKIT.PlayerNumber.One:
        ...
        static GetXboxLiveUserContext(player = TOOLKIT.PlayerNumber.One) {
            let context = null;
            if (TOOLKIT.WindowManager.IsWindows()) {
                switch (player) {
                    case TOOLKIT.PlayerNumber.One:
        ...
        static ResetXboxLiveUserContext(player = TOOLKIT.PlayerNumber.One) {
            if (TOOLKIT.WindowManager.IsWindows()) {
                switch (player) {
                    case TOOLKIT.PlayerNumber.One:
        ...
        static GetXboxLiveContextProperty(name) {
            return (TOOLKIT.WindowManager.IsWindows()) ? window.BabylonToolkit.XboxLive.Plugin.getXboxLiveContextProperty(name) : null;
        }
        /** Get xbox live context property if platform services available. (WinRT) */
