...
Our agents have been extensively trained for web game development. The default <a target="_blank" href="https://github.com/babylontoolkit/agent">Agent Persona</a> can be used as code instructions for any AI. 
